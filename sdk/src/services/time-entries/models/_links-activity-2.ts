 ...
 */
export const _linksActivity2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksActivity2} _linksActivity2 - The time entry activity the time entry is categorized as

**Resource**: TimeEntriesActivity - The time entry activity the time entry is categorized as
 ...
 */
export type _LinksActivity2 = z.infer<typeof _linksActivity2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksActivity2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksActivity2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
