 ...
 */
export const _linksSchema5 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSchema5} _linksSchema5 - The time entry schema

**Resource**: Schema - The time entry schema
 ...
 */
export type _LinksSchema5 = z.infer<typeof _linksSchema5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
