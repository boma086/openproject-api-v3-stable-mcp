 ...
 */
export const _linksUser3 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksUser3} _linksUser3 - The user the time entry tracks expenditures for

**Resource**: User - The user the time entry tracks expenditures for
 ...
 */
export type _LinksUser3 = z.infer<typeof _linksUser3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUser3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUser3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
