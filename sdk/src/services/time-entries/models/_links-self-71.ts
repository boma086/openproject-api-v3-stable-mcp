 ...
 */
export const _linksSelf71 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf71} _linksSelf71 - This time entry collection

**Resource**: TimeEntryCollectionModel - This time entry collection
 ...
 */
export type _LinksSelf71 = z.infer<typeof _linksSelf71>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf71Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf71Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
