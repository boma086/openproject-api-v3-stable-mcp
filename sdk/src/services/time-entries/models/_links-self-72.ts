 ...
 */
export const _linksSelf72 = z.lazy(() => {
  return z.object({
...
**Resource**: TimeEntry
 * @typedef  {_LinksSelf72} _linksSelf72 - This time entry

**Resource**: TimeEntry - This time entry
 ...
 */
export type _LinksSelf72 = z.infer<typeof _linksSelf72>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf72Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf72Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
