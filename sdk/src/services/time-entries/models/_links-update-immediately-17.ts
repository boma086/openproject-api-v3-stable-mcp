 ...
 */
export const _linksUpdateImmediately17 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately17} _linksUpdateImmediately17 - Directly perform edits on this time entry

# Conditions

**Permission**: 'edit time entries' or 'edit own time entries' if the time entry belongs to the user - Directly perform edits on this time entry
 ...
 */
export type _LinksUpdateImmediately17 = z.infer<typeof _linksUpdateImmediately17>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately17Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately17Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
