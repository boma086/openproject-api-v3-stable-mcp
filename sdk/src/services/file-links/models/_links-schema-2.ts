 ...
 */
export const _linksSchema2 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSchema2} _linksSchema2 - The schema of this work package

**Resource**: Schema - The schema of this work package
 ...
 */
export type _LinksSchema2 = z.infer<typeof _linksSchema2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
