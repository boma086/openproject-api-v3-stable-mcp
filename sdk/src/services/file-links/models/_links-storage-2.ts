 ...
 */
export const _linksStorage2 = z.lazy(() => {
  return z.object({
...
**Resource**: Storage
 * @typedef  {_LinksStorage2} _linksStorage2 - The storage resource, that is linked to a project with this project storage.

**Resource**: Storage - The storage resource, that is linked to a project with this project storage.
 ...
 */
export type _LinksStorage2 = z.infer<typeof _linksStorage2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorage2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorage2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
