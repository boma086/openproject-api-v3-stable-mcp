 ...
 */
export const _linksAssignee2 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAssignee2} _linksAssignee2 - The person that is intended to work on the work package
 ...
 */
export type _LinksAssignee2 = z.infer<typeof _linksAssignee2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAssignee2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAssignee2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
