 ...
 */
export const _linksSelf28 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf28} _linksSelf28 - This project storage.

**Resource**: ProjectStorage - This project storage.
 ...
 */
export type _LinksSelf28 = z.infer<typeof _linksSelf28>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf28Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf28Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
