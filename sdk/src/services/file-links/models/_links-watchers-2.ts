 ...
 */
export const _linksWatchers2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksWatchers2} _linksWatchers2 - All users that are currently watching this work package

**Resource**: Collection

# Conditions

**Permission** view work package watchers - All users that are currently watching this work package
 ...
 */
export type _LinksWatchers2 = z.infer<typeof _linksWatchers2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatchers2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatchers2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
