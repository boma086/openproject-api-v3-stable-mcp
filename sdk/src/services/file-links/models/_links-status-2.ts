 ...
 */
export const _linksStatus2 = z.lazy(() => {
  return z.object({
...
**Resource**: Status
 * @typedef  {_LinksStatus2} _linksStatus2 - The current status of the work package
 ...
 */
export type _LinksStatus2 = z.infer<typeof _linksStatus2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
