 ...
 */
export const _linksIntegration2 = z.lazy(() => {
  return z.object({
...
**Resource**: Storage
 * @typedef  {_LinksIntegration2} _linksIntegration2 - The resource that integrates this OAuth client credentials. Currently, only `Storage` resources are
able to contain OAuth client credentials.

**Resource**: Storage - The resource that integrates this OAuth client credentials. Currently, only `Storage` resources are
able to contain OAuth client credentials.
 ...
 */
export type _LinksIntegration2 = z.infer<typeof _linksIntegration2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksIntegration2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksIntegration2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
