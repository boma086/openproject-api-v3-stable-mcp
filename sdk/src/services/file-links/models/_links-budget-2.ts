 ...
 */
export const _linksBudget2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksBudget2} _linksBudget2 - The budget this work package is associated to

**Resource**: Budget

# Conditions

**Permission** view cost objects - The budget this work package is associated to
 ...
 */
export type _LinksBudget2 = z.infer<typeof _linksBudget2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksBudget2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksBudget2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
