 ...
 */
export const _linksAncestors2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAncestors2} _linksAncestors2 - A visible ancestor work package of the current work package.
 ...
 */
export type _LinksAncestors2 = z.infer<typeof _linksAncestors2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
