 ...
 */
export const _linksSelf27 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf27} _linksSelf27 - This file links collection

**Resource**: ProjectStorageCollectionModel - This file links collection
 ...
 */
export type _LinksSelf27 = z.infer<typeof _linksSelf27>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf27Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf27Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
