 ...
 */
export const _linksStatus3 = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {_LinksStatus3} _linksStatus3 - The urn of the user specific file link status on its storage. Can be one of:
...
**Resource**: N/A - The urn of the user specific file link status on its storage. Can be one of:
 ...
 */
export type _LinksStatus3 = z.infer<typeof _linksStatus3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
