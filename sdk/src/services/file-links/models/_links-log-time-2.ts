 ...
 */
export const _linksLogTime2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksLogTime2} _linksLogTime2 - Create time entries on the work package
 ...
 */
export type _LinksLogTime2 = z.infer<typeof _linksLogTime2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLogTime2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLogTime2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
