 ...
 */
export const _linksAttachments4 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAttachments4} _linksAttachments4 - The files attached to this work package
 ...
 */
export type _LinksAttachments4 = z.infer<typeof _linksAttachments4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
