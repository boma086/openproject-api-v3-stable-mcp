 ...
 */
export const _linksType2 = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {_LinksType2} _linksType2 - The urn of the storage type. Currently Nextcloud and OneDrive storages are supported.
 ...
 */
export type _LinksType2 = z.infer<typeof _linksType2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
