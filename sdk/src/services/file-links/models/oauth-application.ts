 ...
 */
export const oauthApplication = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {OauthApplication} oauthApplication - The OAuth 2 provider application linked to the storage.

# Conditions

- User has role `admin`

**Resource**: OAuthApplication - The OAuth 2 provider application linked to the storage.
 ...
 */
export const oauthApplicationResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const oauthApplicationRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
