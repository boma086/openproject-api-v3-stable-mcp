 ...
 */
export const _linksAddAttachment3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment3} _linksAddAttachment3 - Attach a file to the work package

# Conditions

- **Permission**: edit work package - Attach a file to the work package
 ...
 */
export type _LinksAddAttachment3 = z.infer<typeof _linksAddAttachment3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
