 ...
 */
export const _linksStorage1 = z.lazy(() => {
  return z.object({
...
**Resource**: Storage
 * @typedef  {_LinksStorage1} _linksStorage1 - The storage resource of the linked file.

**Resource**: Storage - The storage resource of the linked file.
 ...
 */
export type _LinksStorage1 = z.infer<typeof _linksStorage1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorage1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorage1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
