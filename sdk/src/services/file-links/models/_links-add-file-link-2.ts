 ...
 */
export const _linksAddFileLink2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddFileLink2} _linksAddFileLink2 - Add a file link to the work package
 ...
 */
export type _LinksAddFileLink2 = z.infer<typeof _linksAddFileLink2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddFileLink2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddFileLink2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
