 ...
 */
export const projectFolder = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {ProjectFolder} projectFolder - The directory on the storage that is used as a project folder.

**Resource**: StorageFile

# Conditions

Only provided, if the `projectFolderMode` is `manual` or `automatic`. - The directory on the storage that is used as a project folder.
 ...
 */
export const projectFolderResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const projectFolderRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
