 ...
 */
export const _linksSelf23 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf23} _linksSelf23 - This OAuth Client Credentials object

**Resource**: OAuthClientCredentials - This OAuth Client Credentials object
 ...
 */
export type _LinksSelf23 = z.infer<typeof _linksSelf23>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf23Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf23Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
