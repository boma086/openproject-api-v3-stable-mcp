 ...
 */
export const _linksPreviewMarkup2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksPreviewMarkup2} _linksPreviewMarkup2 - Post markup (in markdown) here to receive an HTML-rendered response - Post markup (in markdown) here to receive an HTML-rendered response
 ...
 */
export type _LinksPreviewMarkup2 = z.infer<typeof _linksPreviewMarkup2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviewMarkup2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviewMarkup2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
