 ...
 */
export const _linksOpen2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksOpen2} _linksOpen2 - A link to OpenProject strorage. - A link to OpenProject strorage.
 ...
 */
export type _LinksOpen2 = z.infer<typeof _linksOpen2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksOpen2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksOpen2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
