 ...
 */
export const _linksRemoveWatcher2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksRemoveWatcher2} _linksRemoveWatcher2 - Remove any user from WP watchers
 ...
 */
export type _LinksRemoveWatcher2 = z.infer<typeof _linksRemoveWatcher2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRemoveWatcher2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRemoveWatcher2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
