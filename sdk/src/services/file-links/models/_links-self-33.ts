 ...
 */
export const _linksSelf33 = z.lazy(() => {
  return z.object({
...
**Resource**: UploadLink
 * @typedef  {_LinksSelf33} _linksSelf33 - The resource link of the upload link resource.

As the upload link is a temporal object, and cannot be retrieved again, the
self link usually is `urn:openproject-org:api:v3:storages:upload_link:no_link_provided`.

**Resource**: UploadLink - The resource link of the upload link resource.
 ...
 */
export type _LinksSelf33 = z.infer<typeof _linksSelf33>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf33Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf33Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
