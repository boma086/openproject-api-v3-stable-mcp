 ...
 */
export const _linksPriority2 = z.lazy(() => {
  return z.object({
...
**Resource**: Priority
 * @typedef  {_LinksPriority2} _linksPriority2 - The priority of the work package
 ...
 */
export type _LinksPriority2 = z.infer<typeof _linksPriority2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
