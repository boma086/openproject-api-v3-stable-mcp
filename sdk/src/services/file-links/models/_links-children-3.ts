 ...
 */
export const _linksChildren3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksChildren3} _linksChildren3 - A visible child work package of the current work package.
 ...
 */
export type _LinksChildren3 = z.infer<typeof _linksChildren3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChildren3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChildren3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
