 ...
 */
export const _linksRelations3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksRelations3} _linksRelations3 - Relations this work package is involved in
 ...
 */
export type _LinksRelations3 = z.infer<typeof _linksRelations3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRelations3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRelations3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
