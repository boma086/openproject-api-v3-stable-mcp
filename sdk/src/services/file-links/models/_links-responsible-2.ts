 ...
 */
export const _linksResponsible2 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksResponsible2} _linksResponsible2 - The person that is responsible for the overall outcome
 ...
 */
export type _LinksResponsible2 = z.infer<typeof _linksResponsible2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
