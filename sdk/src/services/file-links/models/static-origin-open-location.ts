 ...
 */
export const staticOriginOpenLocation = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {StaticOriginOpenLocation} staticOriginOpenLocation - A static uri to open the location of the origin file on the storage. Responds with a redirect.

**Resource**: N/A - A static uri to open the location of the origin file on the storage. Responds with a redirect.
 ...
 */
export type StaticOriginOpenLocation = z.infer<typeof staticOriginOpenLocation>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const staticOriginOpenLocationResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const staticOriginOpenLocationRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
