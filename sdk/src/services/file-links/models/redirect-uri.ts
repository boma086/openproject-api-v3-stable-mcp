 ...
 */
export const redirectUri = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {RedirectUri} redirectUri - A redirect URI of the OAuth application

**Resource**: N/A - A redirect URI of the OAuth application
 ...
 */
export const redirectUriResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const redirectUriRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
