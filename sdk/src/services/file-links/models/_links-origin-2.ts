 ...
 */
export const _linksOrigin2 = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {_LinksOrigin2} _linksOrigin2 - The storage's host URL.

**Resource**: N/A - The storage's host URL.
 ...
 */
export type _LinksOrigin2 = z.infer<typeof _linksOrigin2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksOrigin2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksOrigin2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
