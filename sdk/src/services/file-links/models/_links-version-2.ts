 ...
 */
export const _linksVersion2 = z.lazy(() => {
  return z.object({
...
**Resource**: Version
 * @typedef  {_LinksVersion2} _linksVersion2 - The version associated to the work package
 ...
 */
export type _LinksVersion2 = z.infer<typeof _linksVersion2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
