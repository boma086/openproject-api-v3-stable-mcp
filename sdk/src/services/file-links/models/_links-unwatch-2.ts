 ...
 */
export const _linksUnwatch2 = z.lazy(() => {
  return z.object({
...
logged in; watching
 * @typedef  {_LinksUnwatch2} _linksUnwatch2 - Remove current user from WP watchers
 ...
 */
export type _LinksUnwatch2 = z.infer<typeof _linksUnwatch2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnwatch2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnwatch2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
