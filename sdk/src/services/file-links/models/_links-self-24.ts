 ...
 */
export const _linksSelf24 = z.lazy(() => {
  return z.object({
...
**Resource**: Storage
 * @typedef  {_LinksSelf24} _linksSelf24 - This storage resource. Contains the user defined storage name as title.

**Resource**: Storage - This storage resource. Contains the user defined storage name as title.
 ...
 */
export type _LinksSelf24 = z.infer<typeof _linksSelf24>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf24Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf24Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
