 ...
 */
export const _linksUpdate3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdate3} _linksUpdate3 - Form endpoint that aids in preparing and performing edits on a work package
 ...
 */
export type _LinksUpdate3 = z.infer<typeof _linksUpdate3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
