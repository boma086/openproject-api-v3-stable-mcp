 ...
 */
export const _linksSelf25 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf25} _linksSelf25 - This work package

**Resource**: WorkPackage - This work package
 ...
 */
export type _LinksSelf25 = z.infer<typeof _linksSelf25>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf25Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf25Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
