 ...
 */
export const _linksAvailableWatchers2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAvailableWatchers2} _linksAvailableWatchers2 - All users that can be added to the work package as watchers.
 ...
 */
export type _LinksAvailableWatchers2 = z.infer<typeof _linksAvailableWatchers2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableWatchers2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableWatchers2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
