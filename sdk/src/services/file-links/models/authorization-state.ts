 ...
 */
export const authorizationState = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {AuthorizationState} authorizationState - The urn of the storage connection state. Can be one of:

- urn:openproject-org:api:v3:storages:authorization:Connected
- urn:openproject-org:api:v3:storages:authorization:FailedAuthorization
- urn:openproject-org:api:v3:storages:authorization:Error

**Resource**: N/A - The urn of the storage connection state. Can be one of:
 ...
 */
export const authorizationStateResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const authorizationStateRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
