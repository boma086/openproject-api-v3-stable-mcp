 ...
 */
export const _linksProject6 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject6} _linksProject6 - The project resource, that is linked to a storage with this project storage.

**Resource**: Project - The project resource, that is linked to a storage with this project storage.
 ...
 */
export type _LinksProject6 = z.infer<typeof _linksProject6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
