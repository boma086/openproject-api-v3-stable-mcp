 ...
 */
export const _linksParent3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent3} _linksParent3 - Parent work package

**Resource**: WorkPackage - Parent work package
 ...
 */
export type _LinksParent3 = z.infer<typeof _linksParent3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
