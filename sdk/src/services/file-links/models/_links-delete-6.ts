 ...
 */
export const _linksDelete6 = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {_LinksDelete6} _linksDelete6 - The uri to delete the file link.

**Resource**: N/A - The uri to delete the file link.
 ...
 */
export type _LinksDelete6 = z.infer<typeof _linksDelete6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
