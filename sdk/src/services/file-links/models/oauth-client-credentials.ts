 ...
 */
export const oauthClientCredentials = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {OauthClientCredentials} oauthClientCredentials - The OAuth 2 credentials resource linked to the storage.

# Conditions

- User has role `admin`

**Resource**: OAuthClientCredentials - The OAuth 2 credentials resource linked to the storage.
 ...
 */
export type OauthClientCredentials = z.infer<typeof oauthClientCredentials>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const oauthClientCredentialsResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const oauthClientCredentialsRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
