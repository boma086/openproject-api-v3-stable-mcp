 ...
 */
export const _linksFileLinks2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksFileLinks2} _linksFileLinks2 - Gets the file link collection of this work package
 ...
 */
export type _LinksFileLinks2 = z.infer<typeof _linksFileLinks2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksFileLinks2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksFileLinks2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
