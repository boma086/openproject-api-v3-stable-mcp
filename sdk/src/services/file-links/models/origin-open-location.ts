 ...
 */
export const originOpenLocation = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {OriginOpenLocation} originOpenLocation - The uri to open the location of origin file on the origin itself.

**Resource**: N/A - The uri to open the location of origin file on the origin itself.
 ...
 */
export type OriginOpenLocation = z.infer<typeof originOpenLocation>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const originOpenLocationResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const originOpenLocationRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
