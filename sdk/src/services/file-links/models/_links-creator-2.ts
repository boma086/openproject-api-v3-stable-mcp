 ...
 */
export const _linksCreator2 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksCreator2} _linksCreator2 - The user who created the project storage.

**Resource**: User - The user who created the project storage.
 ...
 */
export type _LinksCreator2 = z.infer<typeof _linksCreator2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreator2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreator2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
