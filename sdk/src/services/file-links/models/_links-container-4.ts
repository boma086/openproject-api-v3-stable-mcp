 ...
 */
export const _linksContainer4 = z.lazy(() => {
  return z.object({
...
- WorkPackage
 * @typedef  {_LinksContainer4} _linksContainer4 - The container the origin file is linked to.

Can be one of the following **Resources**:

- WorkPackage - The container the origin file is linked to.
 ...
 */
export type _LinksContainer4 = z.infer<typeof _linksContainer4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
