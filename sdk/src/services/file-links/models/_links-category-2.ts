 ...
 */
export const _linksCategory2 = z.lazy(() => {
  return z.object({
...
**Resource**: Category
 * @typedef  {_LinksCategory2} _linksCategory2 - The category of the work package

**Resource**: Category - The category of the work package
 ...
 */
export type _LinksCategory2 = z.infer<typeof _linksCategory2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
