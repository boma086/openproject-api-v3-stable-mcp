 ...
 */
export const _linksSelf26 = z.lazy(() => {
  return z.object({
...
**Resource**: FileLink
 * @typedef  {_LinksSelf26} _linksSelf26 - This file link.

**Resource**: FileLink - This file link.
 ...
 */
export type _LinksSelf26 = z.infer<typeof _linksSelf26>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf26Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf26Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
