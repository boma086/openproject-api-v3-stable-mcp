 ...
 */
export const _linksAddComment2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddComment2} _linksAddComment2 - Post comment to WP

# Conditions

**Permission**: add work package notes - Post comment to WP
 ...
 */
export type _LinksAddComment2 = z.infer<typeof _linksAddComment2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddComment2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddComment2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
