 ...
 */
export const _linksType3 = z.lazy(() => {
  return z.object({
...
**Resource**: Type
 * @typedef  {_LinksType3} _linksType3 - The type of the work package
 ...
 */
export type _LinksType3 = z.infer<typeof _linksType3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
