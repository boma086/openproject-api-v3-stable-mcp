 ...
 */
export const _linksCopy2 = z.lazy(() => {
  return z.object({
...
/**
 * Link to page for copying this work package

# Conditions

**Permission**: add_work_packages
 * @typedef  {_LinksCopy2} _linksCopy2 - Link to page for copying this work package

# Conditions

**Permission**: add_work_packages - Link to page for copying this work package
 ...
 */
export type _LinksCopy2 = z.infer<typeof _linksCopy2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCopy2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCopy2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
