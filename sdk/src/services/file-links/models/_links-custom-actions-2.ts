 ...
 */
export const _linksCustomActions2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCustomActions2} _linksCustomActions2 - A predefined action that can be applied to the work package.

**Resource**: CustomAction - A predefined action that can be applied to the work package.
 ...
 */
export type _LinksCustomActions2 = z.infer<typeof _linksCustomActions2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCustomActions2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCustomActions2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
