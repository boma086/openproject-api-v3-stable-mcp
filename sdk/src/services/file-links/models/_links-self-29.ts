 ...
 */
export const _linksSelf29 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf29} _linksSelf29 - This storage collection

**Resource**: StorageCollectionReadModel - This storage collection
 ...
 */
export type _LinksSelf29 = z.infer<typeof _linksSelf29>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf29Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf29Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
