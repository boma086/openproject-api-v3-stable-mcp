 ...
 */
export const _linksAuthor5 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAuthor5} _linksAuthor5 - The person that created the work package

**Resource**: User - The person that created the work package
 ...
 */
export type _LinksAuthor5 = z.infer<typeof _linksAuthor5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
