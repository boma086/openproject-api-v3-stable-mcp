 ...
 */
export const _linksSelf22 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf22} _linksSelf22 - This OAuth application

**Resource**: OAuthApplication - This OAuth application
 ...
 */
export type _LinksSelf22 = z.infer<typeof _linksSelf22>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf22Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf22Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
