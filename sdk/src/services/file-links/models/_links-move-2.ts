 ...
 */
export const _linksMove2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksMove2} _linksMove2 - Link to page for moving this work package
 ...
 */
export type _LinksMove2 = z.infer<typeof _linksMove2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMove2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMove2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
