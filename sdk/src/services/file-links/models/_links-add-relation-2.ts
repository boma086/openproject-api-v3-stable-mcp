 ...
 */
export const _linksAddRelation2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddRelation2} _linksAddRelation2 - Adds a relation to this work package.

# Conditions

**Permission**: manage wp relations - Adds a relation to this work package.
 ...
 */
export type _LinksAddRelation2 = z.infer<typeof _linksAddRelation2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddRelation2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddRelation2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
