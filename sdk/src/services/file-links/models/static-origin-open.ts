 ...
 */
export const staticOriginOpen = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {StaticOriginOpen} staticOriginOpen - A static uri to open the origin file on the storage. Responds with a redirect.

**Resource**: N/A - A static uri to open the origin file on the storage. Responds with a redirect.
 ...
 */
export type StaticOriginOpen = z.infer<typeof staticOriginOpen>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const staticOriginOpenResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const staticOriginOpenRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
