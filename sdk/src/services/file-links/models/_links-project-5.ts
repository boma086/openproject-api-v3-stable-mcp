 ...
 */
export const _linksProject5 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject5} _linksProject5 - The project to which the work package belongs
 ...
 */
export type _LinksProject5 = z.infer<typeof _linksProject5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
