 ...
 */
export const _linksDelete5 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete5} _linksDelete5 - Delete this work package

# Conditions

**Permission**: delete_work_packages - Delete this work package
 ...
 */
export type _LinksDelete5 = z.infer<typeof _linksDelete5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
