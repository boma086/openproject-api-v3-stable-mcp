 ...
 */
export const _linksUpdateImmediately2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately2} _linksUpdateImmediately2 - Directly perform edits on a work package

# Conditions

**Permission**: edit work package - Directly perform edits on a work package
 ...
 */
export type _LinksUpdateImmediately2 = z.infer<typeof _linksUpdateImmediately2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
