...
import { z } from 'zod';
import { ParentType, parentType } from './parent-type';
import { ParentLinks, parentLinks, parentLinksRequest, parentLinksResponse } from './parent-links';

/**
 * The shape of the model inside the application code - what the users use
 */
export const storageFilesModelParent = z.lazy(() => {
  return z.object({
    id: z.string(),
    name: z.string(),
 ...
 * @typedef  {StorageFilesModelParent} storageFilesModelParent - File of the currently selected parent directory. - File of the currently selected parent directory.
 ...
 * @property {ParentLinks} 
 */
export type StorageFilesModelParent = z.infer<typeof storageFilesModelParent>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const storageFilesModelParentResponse = z.lazy(() => {
  return z
    .object({
      id: z.string(),
      name: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const storageFilesModelParentRequest = z.lazy(() => {
  return z
    .object({
      id: z.string(),
      name: z.string(),
