 ...
 */
export const _linksWatch2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksWatch2} _linksWatch2 - Add current user to WP watchers

# Conditions

logged in; not watching - Add current user to WP watchers
 ...
 */
export type _LinksWatch2 = z.infer<typeof _linksWatch2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatch2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatch2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
