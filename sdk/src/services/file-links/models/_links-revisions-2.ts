 ...
 */
export const _linksRevisions2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksRevisions2} _linksRevisions2 - Revisions that are referencing the work package
 ...
 */
export type _LinksRevisions2 = z.infer<typeof _linksRevisions2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRevisions2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRevisions2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
