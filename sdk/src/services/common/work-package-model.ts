...
import { z } from 'zod';
import { WorkPackageModelType, workPackageModelType } from '../file-links/models/work-package-model-type';
import {
  WorkPackageModelDescription,
  workPackageModelDescription,
  workPackageModelDescriptionRequest,
  workPackageModelDescriptionResponse,
} from '../file-links/models/work-package-model-description';
import {
  WorkPackageModelLinks,
  workPackageModelLinks,
  workPackageModelLinksRequest,
  workPackageModelLinksResponse,
} from '../file-links/models/work-package-model-links';

/**
 * The shape of the model inside the application code - what the users use
 */
export const workPackageModel = z.lazy(() => {
  return z.object({
    id: z.number().gte(1).optional(),
    lockVersion: z.number().optional(),
    subject: z.string(),
    _type: workPackageModelType.optional(),
...
/**
 * 
 * @typedef  {WorkPackageModel} workPackageModel   
 ...
 * @property {WorkPackageModelType} 
 * @property {WorkPackageModelDescription} - The work package description
 ...
 * @property {WorkPackageModelLinks} 
 */
export type WorkPackageModel = z.infer<typeof workPackageModel>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const workPackageModelResponse = z.lazy(() => {
  return z
    .object({
      id: z.number().gte(1).optional(),
      lockVersion: z.number().optional(),
      subject: z.string(),
      _type: workPackageModelType.optional(),
      description: workPackageModelDescriptionResponse.optional(),
      scheduleManually: z.boolean().optional(),
      readonly: z.boolean().optional(),
      startDate: z.string().optional(),
      dueDate: z.string().optional(),
      ...
      createdAt: z.string().optional(),
      updatedAt: z.string().optional(),
      _links: workPackageModelLinksResponse,
    })
    .transform((data) => ({
      id: data['id'],
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const workPackageModelRequest = z.lazy(() => {
  return z
    .object({
      id: z.number().gte(1).optional(),
      lockVersion: z.number().optional(),
      subject: z.string(),
      _type: workPackageModelType.optional(),
      description: workPackageModelDescriptionRequest.optional(),
      scheduleManually: z.boolean().optional(),
      readonly: z.boolean().optional(),
      startDate: z.string().optional(),
      dueDate: z.string().optional(),
      ...
      createdAt: z.string().optional(),
      updatedAt: z.string().optional(),
      _links: workPackageModelLinksRequest,
    })
    .transform((data) => ({
      id: data['id'],
      lockVersion: data['lockVersion'],
