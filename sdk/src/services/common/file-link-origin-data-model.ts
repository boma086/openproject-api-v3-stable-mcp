 ...
 */
export const fileLinkOriginDataModel = z.lazy(() => {
  return z.object({
    id: z.string(),
    name: z.string(),
...
/**
 * 
 * @typedef  {FileLinkOriginDataModel} fileLinkOriginDataModel   
 ...
 */
export type FileLinkOriginDataModel = z.infer<typeof fileLinkOriginDataModel>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const fileLinkOriginDataModelResponse = z.lazy(() => {
  return z
    .object({
      id: z.string(),
      name: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const fileLinkOriginDataModelRequest = z.lazy(() => {
  return z
    .object({
      id: z.string(),
      name: z.string(),
