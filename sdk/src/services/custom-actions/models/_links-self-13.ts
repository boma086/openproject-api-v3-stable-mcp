 ...
 */
export const _linksSelf13 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf13} _linksSelf13 - This custom action

**Resource**: CustomAction - This custom action
 ...
 */
export type _LinksSelf13 = z.infer<typeof _linksSelf13>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf13Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf13Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
