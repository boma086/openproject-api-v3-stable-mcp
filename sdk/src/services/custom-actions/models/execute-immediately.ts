 ...
 */
export const executeImmediately = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {ExecuteImmediately} executeImmediately - Execute this custom action. - Execute this custom action.
 ...
 */
export type ExecuteImmediately = z.infer<typeof executeImmediately>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const executeImmediatelyResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const executeImmediatelyRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
