 ...
 */
export const _linksShowUser1 = z.lazy(() => {
  return z.object({
...
- User is not `locked`
 * @typedef  {_LinksShowUser1} _linksShowUser1 - A relative path to show the user in the web application.

# Condition

- User is not a new record
- User is not `locked` - A relative path to show the user in the web application.
 ...
 */
export type _LinksShowUser1 = z.infer<typeof _linksShowUser1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
