 ...
 */
export const _linksWorkPackages2 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksWorkPackages2} _linksWorkPackages2 - Work Packages of this project
 ...
 */
export type _LinksWorkPackages2 = z.infer<typeof _linksWorkPackages2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackages2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackages2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
