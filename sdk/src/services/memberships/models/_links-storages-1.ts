 ...
 */
export const _linksStorages1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksStorages1} _linksStorages1 - The link to a storage that is active for this project.

**Resource**: Storage

# Conditions

**Permission**: view_file_links - The link to a storage that is active for this project.
 ...
 */
export type _LinksStorages1 = z.infer<typeof _linksStorages1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorages1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorages1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
