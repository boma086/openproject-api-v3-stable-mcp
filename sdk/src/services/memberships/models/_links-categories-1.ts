 ...
 */
export const _linksCategories1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksCategories1} _linksCategories1 - Categories available in this project
 ...
 */
export type _LinksCategories1 = z.infer<typeof _linksCategories1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategories1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategories1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
