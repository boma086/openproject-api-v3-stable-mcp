 ...
 */
export const _linksSelf44 = z.lazy(() => {
  return z.object({
...
**Resource**: Form
 * @typedef  {_LinksSelf44} _linksSelf44 - This form request.

**Resource**: Form - This form request.
 ...
 */
export type _LinksSelf44 = z.infer<typeof _linksSelf44>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf44Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf44Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
