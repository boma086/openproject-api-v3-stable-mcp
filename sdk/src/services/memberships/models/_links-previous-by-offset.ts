 ...
 */
export const _linksPreviousByOffset = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksPreviousByOffset} _linksPreviousByOffset - A link to the previous page of the collection.
 ...
 */
export type _LinksPreviousByOffset = z.infer<typeof _linksPreviousByOffset>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviousByOffsetResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviousByOffsetRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
