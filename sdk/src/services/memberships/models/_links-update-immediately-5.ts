 ...
 */
export const _linksUpdateImmediately5 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately5} _linksUpdateImmediately5 - Directly update this project
 ...
 */
export type _LinksUpdateImmediately5 = z.infer<typeof _linksUpdateImmediately5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
