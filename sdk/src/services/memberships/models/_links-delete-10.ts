 ...
 */
export const _linksDelete10 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete10} _linksDelete10 - Permanently remove a user from the instance
...
or:
  - User is self
  - Setting `users_deletable_by_self` is set - Permanently remove a user from the instance
 ...
 */
export type _LinksDelete10 = z.infer<typeof _linksDelete10>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete10Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete10Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
