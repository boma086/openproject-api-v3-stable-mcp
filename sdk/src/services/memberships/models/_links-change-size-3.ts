 ...
 */
export const _linksChangeSize3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksChangeSize3} _linksChangeSize3 - A templated link to change the current page size. - A templated link to change the current page size.
 ...
 */
export type _LinksChangeSize3 = z.infer<typeof _linksChangeSize3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
