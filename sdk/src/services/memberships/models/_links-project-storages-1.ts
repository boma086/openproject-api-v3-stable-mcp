 ...
 */
export const _linksProjectStorages1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksProjectStorages1} _linksProjectStorages1 - The project storage collection of this project.

**Resource**: Collection

# Conditions

**Permission**: view_file_links - The project storage collection of this project.
 ...
 */
export type _LinksProjectStorages1 = z.infer<typeof _linksProjectStorages1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProjectStorages1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProjectStorages1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
