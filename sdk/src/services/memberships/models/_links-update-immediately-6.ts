 ...
 */
export const _linksUpdateImmediately6 = z.lazy(() => {
  return z.object({
...
- `admin`
 * @typedef  {_LinksUpdateImmediately6} _linksUpdateImmediately6 - A link to update the user resource.
 ...
 */
export type _LinksUpdateImmediately6 = z.infer<typeof _linksUpdateImmediately6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
