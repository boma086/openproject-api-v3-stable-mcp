 ...
 */
export const representations = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {Representations} representations - A project collection representation in a specific file format. - A project collection representation in a specific file format.
 ...
 */
export const representationsResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const representationsRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
