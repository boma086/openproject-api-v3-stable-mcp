 ...
 */
export const _linksRoles2 = z.lazy(() => {
  return z.object({
...
**Resource**: Role
 * @typedef  {_LinksRoles2} _linksRoles2 - A role the principal has.
 ...
 */
export type _LinksRoles2 = z.infer<typeof _linksRoles2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRoles2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRoles2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
