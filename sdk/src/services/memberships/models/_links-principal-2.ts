 ...
 */
export const _linksPrincipal2 = z.lazy(() => {
  return z.object({
...
**Resource**: Principal
 * @typedef  {_LinksPrincipal2} _linksPrincipal2 - The principal that is to get a membership.

**Resource**: Principal - The principal that is to get a membership.
 ...
 */
export type _LinksPrincipal2 = z.infer<typeof _linksPrincipal2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPrincipal2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPrincipal2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
