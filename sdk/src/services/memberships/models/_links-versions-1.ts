 ...
 */
export const _linksVersions1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksVersions1} _linksVersions1 - Versions available in this project
 ...
 */
export type _LinksVersions1 = z.infer<typeof _linksVersions1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersions1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersions1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
