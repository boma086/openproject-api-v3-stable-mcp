 ...
 */
export const _linksSelf43 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSelf43} _linksSelf43 - This schema
 ...
 */
export type _LinksSelf43 = z.infer<typeof _linksSelf43>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf43Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf43Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
