 ...
 */
export const _linksSelf42 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksSelf42} _linksSelf42 - This collection resource.
 ...
 */
export type _LinksSelf42 = z.infer<typeof _linksSelf42>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf42Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf42Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
