 ...
 */
export const _linksPrincipal1 = z.lazy(() => {
  return z.object({
...
**Resource**: Principal
 * @typedef  {_LinksPrincipal1} _linksPrincipal1 - The principal the membership is related to.

**Resource**: Principal - The principal the membership is related to.
 ...
 */
export type _LinksPrincipal1 = z.infer<typeof _linksPrincipal1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPrincipal1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPrincipal1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
