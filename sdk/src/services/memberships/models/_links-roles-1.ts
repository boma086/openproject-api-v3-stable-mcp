 ...
 */
export const _linksRoles1 = z.lazy(() => {
  return z.object({
...
**Resource**: Role
 * @typedef  {_LinksRoles1} _linksRoles1 - A role the principal has.

**Resource**: Role - A role the principal has.
 ...
 */
export type _LinksRoles1 = z.infer<typeof _linksRoles1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRoles1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRoles1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
