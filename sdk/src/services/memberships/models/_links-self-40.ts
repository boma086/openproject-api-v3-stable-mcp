 ...
 */
export const _linksSelf40 = z.lazy(() => {
  return z.object({
...
**Resource**: Role
 * @typedef  {_LinksSelf40} _linksSelf40 - This role
 ...
 */
export type _LinksSelf40 = z.infer<typeof _linksSelf40>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf40Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf40Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
