 ...
 */
export const _linksProject8 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject8} _linksProject8 - The project the membership is related to.

**Resource**: Project - The project the membership is related to.
 ...
 */
export type _LinksProject8 = z.infer<typeof _linksProject8>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject8Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject8Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
