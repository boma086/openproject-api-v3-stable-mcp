 ...
 */
export const _linksNextByOffset = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksNextByOffset} _linksNextByOffset - A link to the next page of the collection.
 ...
 */
export type _LinksNextByOffset = z.infer<typeof _linksNextByOffset>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksNextByOffsetResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksNextByOffsetRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
