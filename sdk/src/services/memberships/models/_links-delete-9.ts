 ...
 */
export const _linksDelete9 = z.lazy(() => {
  return z.object({
...
**Permission**: admin
 * @typedef  {_LinksDelete9} _linksDelete9 - Delete this project
 ...
 */
export type _LinksDelete9 = z.infer<typeof _linksDelete9>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete9Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete9Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
