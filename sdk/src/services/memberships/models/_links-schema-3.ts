 ...
 */
export const _linksSchema3 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSchema3} _linksSchema3 - This membership schema.

**Resource**: Schema - This membership schema.
 ...
 */
export type _LinksSchema3 = z.infer<typeof _linksSchema3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
