 ...
 */
export const _linksJumpTo2 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksJumpTo2} _linksJumpTo2 - Templated link to another page offset.
 ...
 */
export type _LinksJumpTo2 = z.infer<typeof _linksJumpTo2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
