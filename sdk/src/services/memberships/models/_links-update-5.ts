 ...
 */
export const _linksUpdate5 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdate5} _linksUpdate5 - Form endpoint that aids in updating this project

# Conditions

**Permission**: edit project - Form endpoint that aids in updating this project
 ...
 */
export type _LinksUpdate5 = z.infer<typeof _linksUpdate5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
