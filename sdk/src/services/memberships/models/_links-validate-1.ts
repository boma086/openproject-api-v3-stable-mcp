 ...
 */
export const _linksValidate1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksValidate1} _linksValidate1 - The endpoint to validate the membership payload. - The endpoint to validate the membership payload.
 ...
 */
export type _LinksValidate1 = z.infer<typeof _linksValidate1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksValidate1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksValidate1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
