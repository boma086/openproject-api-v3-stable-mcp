 ...
 */
export const _linksParent4 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent4} _linksParent4 - Parent project of the project

**Resource**: Project

# Conditions

**Permission** edit project - Parent project of the project
 ...
 */
export type _LinksParent4 = z.infer<typeof _linksParent4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
