 ...
 */
export const _linksMemberships2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksMemberships2} _linksMemberships2 - Memberships in the  project
 ...
 */
export type _LinksMemberships2 = z.infer<typeof _linksMemberships2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMemberships2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMemberships2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
