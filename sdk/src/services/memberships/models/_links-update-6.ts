 ...
 */
export const _linksUpdate6 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdate6} _linksUpdate6 - The endpoint for updating the membership.

# Conditions

**Permission**: manage_members - The endpoint for updating the membership.
 ...
 */
export type _LinksUpdate6 = z.infer<typeof _linksUpdate6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
