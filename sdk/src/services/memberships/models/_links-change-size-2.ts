 ...
 */
export const _linksChangeSize2 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksChangeSize2} _linksChangeSize2 - Templated link for another page size.
 ...
 */
export type _LinksChangeSize2 = z.infer<typeof _linksChangeSize2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
