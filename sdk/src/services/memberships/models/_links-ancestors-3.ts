 ...
 */
export const _linksAncestors3 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksAncestors3} _linksAncestors3 - The link to an ancestor project.

**Resource**: Project - The link to an ancestor project.
 ...
 */
export type _LinksAncestors3 = z.infer<typeof _linksAncestors3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
