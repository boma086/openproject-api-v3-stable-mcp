...
**Resource**: Membership
 * @typedef  {Commit} commit - The endpoint to create the membership with the same payload, as sent to the form.

**Resource**: Membership - The endpoint to create the membership with the same payload, as sent to the form.
 ...
 */
export const commitResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const commitRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
