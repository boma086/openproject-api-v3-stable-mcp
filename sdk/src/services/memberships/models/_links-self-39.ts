 ...
 */
export const _linksSelf39 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksSelf39} _linksSelf39 - This project
 ...
 */
export type _LinksSelf39 = z.infer<typeof _linksSelf39>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf39Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf39Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
