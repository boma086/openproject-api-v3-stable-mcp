 ...
 */
export const _linksCreateWorkPackage1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCreateWorkPackage1} _linksCreateWorkPackage1 - Form endpoint that aids in preparing and creating a work package
 ...
 */
export type _LinksCreateWorkPackage1 = z.infer<typeof _linksCreateWorkPackage1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackage1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackage1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
