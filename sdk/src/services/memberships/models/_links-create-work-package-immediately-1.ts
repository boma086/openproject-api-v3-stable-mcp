 ...
 */
export const _linksCreateWorkPackageImmediately1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCreateWorkPackageImmediately1} _linksCreateWorkPackageImmediately1 - Directly creates a work package in the project

# Conditions

**Permission**: add work packages - Directly creates a work package in the project
 ...
 */
export type _LinksCreateWorkPackageImmediately1 = z.infer<typeof _linksCreateWorkPackageImmediately1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackageImmediately1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackageImmediately1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
