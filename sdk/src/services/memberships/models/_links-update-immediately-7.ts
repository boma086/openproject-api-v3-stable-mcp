 ...
 */
export const _linksUpdateImmediately7 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately7} _linksUpdateImmediately7 - The endpoint for updating the membership without form validation.

# Conditions

**Permission**: manage_members - The endpoint for updating the membership without form validation.
 ...
 */
export type _LinksUpdateImmediately7 = z.infer<typeof _linksUpdateImmediately7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
