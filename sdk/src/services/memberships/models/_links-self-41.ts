 ...
 */
export const _linksSelf41 = z.lazy(() => {
  return z.object({
...
**Resource**: Membership
 * @typedef  {_LinksSelf41} _linksSelf41 - This membership.

**Resource**: Membership - This membership.
 ...
 */
export type _LinksSelf41 = z.infer<typeof _linksSelf41>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf41Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf41Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
