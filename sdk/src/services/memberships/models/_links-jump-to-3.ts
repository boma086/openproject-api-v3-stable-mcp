 ...
 */
export const _linksJumpTo3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksJumpTo3} _linksJumpTo3 - A templated link to jump to a given offset. - A templated link to jump to a given offset.
 ...
 */
export type _LinksJumpTo3 = z.infer<typeof _linksJumpTo3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
