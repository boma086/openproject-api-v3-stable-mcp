 ...
 */
export const _linksSelf16 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf16} _linksSelf16 - This custom option.

**Resource**: CustomOption - This custom option.
 ...
 */
export type _LinksSelf16 = z.infer<typeof _linksSelf16>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf16Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf16Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
