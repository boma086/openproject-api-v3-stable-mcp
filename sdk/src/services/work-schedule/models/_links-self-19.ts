 ...
 */
export const _linksSelf19 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf19} _linksSelf19 - This week days collection

**Resource**: WeekDayCollectionModel - This week days collection
 ...
 */
export type _LinksSelf19 = z.infer<typeof _linksSelf19>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf19Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf19Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
