 ...
 */
export const _linksSelf17 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf17} _linksSelf17 - This non working days collection

**Resource**: NonWorkingDayCollectionModel - This non working days collection
 ...
 */
export type _LinksSelf17 = z.infer<typeof _linksSelf17>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf17Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf17Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
