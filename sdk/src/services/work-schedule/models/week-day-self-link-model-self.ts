 ...
 */
export const weekDaySelfLinkModelSelf = z.lazy(() => {
  return z.object({
...
**Resource**: WeekDay
 * @typedef  {WeekDaySelfLinkModelSelf} weekDaySelfLinkModelSelf - This week day resource link.

**Resource**: WeekDay - This week day resource link.
 ...
 */
export type WeekDaySelfLinkModelSelf = z.infer<typeof weekDaySelfLinkModelSelf>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const weekDaySelfLinkModelSelfResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const weekDaySelfLinkModelSelfRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
