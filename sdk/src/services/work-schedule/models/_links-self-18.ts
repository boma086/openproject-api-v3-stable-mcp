 ...
 */
export const _linksSelf18 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf18} _linksSelf18 - This non-working day.

**Resource**: NonWorkingDay - This non-working day.
 ...
 */
export type _LinksSelf18 = z.infer<typeof _linksSelf18>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf18Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf18Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
