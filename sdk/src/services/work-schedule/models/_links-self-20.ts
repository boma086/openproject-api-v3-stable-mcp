 ...
 */
export const _linksSelf20 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf20} _linksSelf20 - This days collection

**Resource**: DayCollectionModel - This days collection
 ...
 */
export type _LinksSelf20 = z.infer<typeof _linksSelf20>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf20Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf20Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
