 ...
 */
export const _linksSelf36 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf36} _linksSelf36 - This help text collection

**Resource**: HelpTextCollectionModel - This help text collection
 ...
 */
export type _LinksSelf36 = z.infer<typeof _linksSelf36>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf36Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf36Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
