...
**Resource**: text/html
 * @typedef  {EditText} editText - Edit the help text entry.

**Resource**: text/html - Edit the help text entry.
 ...
 */
export type EditText = z.infer<typeof editText>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const editTextResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const editTextRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
