 ...
 */
export const _linksSelf37 = z.lazy(() => {
  return z.object({
...
**Resource**: HelpText
 * @typedef  {_LinksSelf37} _linksSelf37 - This help text resource.

**Resource**: HelpText - This help text resource.
 ...
 */
export type _LinksSelf37 = z.infer<typeof _linksSelf37>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf37Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf37Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
