 ...
 */
export const _linksAttachments6 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAttachments6} _linksAttachments6 - The attachment collection of this help text.

**Resource**: AttachmentCollection - The attachment collection of this help text.
 ...
 */
export type _LinksAttachments6 = z.infer<typeof _linksAttachments6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
