 ...
 */
export const _linksAddAttachment5 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment5} _linksAddAttachment5 - Add an attachment to the help text. - Add an attachment to the help text.
 ...
 */
export type _LinksAddAttachment5 = z.infer<typeof _linksAddAttachment5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
