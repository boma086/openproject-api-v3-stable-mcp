 ...
 */
export const _linksAttachments7 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAttachments7} _linksAttachments7 - The attachment collection of this grid.
 ...
 */
export type _LinksAttachments7 = z.infer<typeof _linksAttachments7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
