 ...
 */
export const _linksSelf38 = z.lazy(() => {
  return z.object({
...
**Resource**: Meeting
 * @typedef  {_LinksSelf38} _linksSelf38 - This meeting

**Resource**: Meeting - This meeting
 ...
 */
export type _LinksSelf38 = z.infer<typeof _linksSelf38>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf38Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf38Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
