 ...
 */
export const _linksProject7 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject7} _linksProject7 - The project the meeting is in

**Resource**: Project - The project the meeting is in
 ...
 */
export type _LinksProject7 = z.infer<typeof _linksProject7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
