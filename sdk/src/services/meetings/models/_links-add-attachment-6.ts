 ...
 */
export const _linksAddAttachment6 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment6} _linksAddAttachment6 - Attach a file to the meeting

# Conditions

**Permission**: edit meeting - Attach a file to the meeting
 ...
 */
export type _LinksAddAttachment6 = z.infer<typeof _linksAddAttachment6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
