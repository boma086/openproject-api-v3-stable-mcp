 ...
 */
export const _linksAddAttachment8 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment8} _linksAddAttachment8 - Attach a file to the wiki page

# Conditions

**Permission**: edit wiki page - Attach a file to the wiki page
 ...
 */
export type _LinksAddAttachment8 = z.infer<typeof _linksAddAttachment8>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment8Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment8Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
