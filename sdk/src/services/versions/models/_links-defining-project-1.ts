 ...
 */
export const _linksDefiningProject1 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksDefiningProject1} _linksDefiningProject1 - The project to which the version belongs
 ...
 */
export type _LinksDefiningProject1 = z.infer<typeof _linksDefiningProject1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefiningProject1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefiningProject1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
