 ...
 */
export const _linksSelf66 = z.lazy(() => {
  return z.object({
...
**Resource**: Version
 * @typedef  {_LinksSelf66} _linksSelf66 - This version
 ...
 */
export type _LinksSelf66 = z.infer<typeof _linksSelf66>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf66Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf66Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
