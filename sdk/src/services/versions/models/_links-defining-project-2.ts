 ...
 */
export const _linksDefiningProject2 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksDefiningProject2} _linksDefiningProject2 - The project to which the version belongs

**Resource**: Project - The project to which the version belongs
 ...
 */
export type _LinksDefiningProject2 = z.infer<typeof _linksDefiningProject2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefiningProject2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefiningProject2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
