 ...
 */
export const _linksUpdateImmediately14 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately14} _linksUpdateImmediately14 - Directly perform edits on the version

# Conditions

**Permission**: manage versions - Directly perform edits on the version
 ...
 */
export type _LinksUpdateImmediately14 = z.infer<typeof _linksUpdateImmediately14>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately14Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately14Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
