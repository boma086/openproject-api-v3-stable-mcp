 ...
 */
export const _linksAvailableInProjects1 = z.lazy(() => {
  return z.object({
...
**Resource**: Projects
 * @typedef  {_LinksAvailableInProjects1} _linksAvailableInProjects1 - Projects where this version can be used
 ...
 */
export type _LinksAvailableInProjects1 = z.infer<typeof _linksAvailableInProjects1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableInProjects1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableInProjects1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
