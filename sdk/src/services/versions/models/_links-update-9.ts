 ...
 */
export const _linksUpdate9 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdate9} _linksUpdate9 - Form endpoint that aids in preparing and performing edits on the version
 ...
 */
export type _LinksUpdate9 = z.infer<typeof _linksUpdate9>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate9Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate9Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
