 ...
 */
export const _linksUpdateImmediately15 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately15} _linksUpdateImmediately15 - Directly perform edits on the version
 ...
 */
export type _LinksUpdateImmediately15 = z.infer<typeof _linksUpdateImmediately15>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately15Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately15Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
