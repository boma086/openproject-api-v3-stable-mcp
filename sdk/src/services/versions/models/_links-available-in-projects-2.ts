 ...
 */
export const _linksAvailableInProjects2 = z.lazy(() => {
  return z.object({
...
**Resource**: Projects
 * @typedef  {_LinksAvailableInProjects2} _linksAvailableInProjects2 - Projects where this version can be used

**Resource**: Projects - Projects where this version can be used
 ...
 */
export type _LinksAvailableInProjects2 = z.infer<typeof _linksAvailableInProjects2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableInProjects2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableInProjects2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
