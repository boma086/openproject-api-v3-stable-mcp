 ...
 */
export const _linksSelf65 = z.lazy(() => {
  return z.object({
...
**Resource**: Version
 * @typedef  {_LinksSelf65} _linksSelf65 - This version
 ...
 */
export type _LinksSelf65 = z.infer<typeof _linksSelf65>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf65Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf65Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
