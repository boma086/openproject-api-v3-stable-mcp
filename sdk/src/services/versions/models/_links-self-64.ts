 ...
 */
export const _linksSelf64 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf64} _linksSelf64 - The versions collection

**Resource**: VersionsCollection - The versions collection
 ...
 */
export type _LinksSelf64 = z.infer<typeof _linksSelf64>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf64Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf64Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
