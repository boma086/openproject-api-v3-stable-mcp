 ...
 */
export const _linksUpdateImmediately8 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately8} _linksUpdateImmediately8 - Directly perform edits on the news

**Permission** manage news - Directly perform edits on the news
 ...
 */
export type _LinksUpdateImmediately8 = z.infer<typeof _linksUpdateImmediately8>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately8Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately8Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
