 ...
 */
export const _linksProject11 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject11} _linksProject11 - The project the news is situated in

**Resource**: Project - The project the news is situated in
 ...
 */
export type _LinksProject11 = z.infer<typeof _linksProject11>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject11Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject11Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
