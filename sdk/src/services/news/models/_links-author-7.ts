 ...
 */
export const _linksAuthor7 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAuthor7} _linksAuthor7 - The user having created the news

**Resource**: User - The user having created the news
 ...
 */
export type _LinksAuthor7 = z.infer<typeof _linksAuthor7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
