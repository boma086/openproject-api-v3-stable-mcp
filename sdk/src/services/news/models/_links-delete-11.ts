 ...
 */
export const _linksDelete11 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete11} _linksDelete11 - Delete the news

**Permission** manage news - Delete the news
 ...
 */
export type _LinksDelete11 = z.infer<typeof _linksDelete11>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete11Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete11Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
