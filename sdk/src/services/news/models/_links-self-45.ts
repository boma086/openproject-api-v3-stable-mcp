 ...
 */
export const _linksSelf45 = z.lazy(() => {
  return z.object({
...
**Resource**: News
 * @typedef  {_LinksSelf45} _linksSelf45 - This news

**Resource**: News - This news
 ...
 */
export type _LinksSelf45 = z.infer<typeof _linksSelf45>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf45Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf45Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
