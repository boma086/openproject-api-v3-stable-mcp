 ...
 */
export const _linksProject10 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject10} _linksProject10 - The project the news is situated in
 ...
 */
export type _LinksProject10 = z.infer<typeof _linksProject10>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject10Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject10Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
