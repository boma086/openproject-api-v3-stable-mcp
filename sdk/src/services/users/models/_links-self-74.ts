 ...
 */
export const _linksSelf74 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksSelf74} _linksSelf74 - This user collection

**Resource**: Collection - This user collection
 ...
 */
export type _LinksSelf74 = z.infer<typeof _linksSelf74>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf74Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf74Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
