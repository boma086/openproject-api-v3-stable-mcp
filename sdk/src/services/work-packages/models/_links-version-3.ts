 ...
 */
export const _linksVersion3 = z.lazy(() => {
  return z.object({
...
**Resource**: Version
 * @typedef  {_LinksVersion3} _linksVersion3 - The version associated to the work package
 ...
 */
export type _LinksVersion3 = z.infer<typeof _linksVersion3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
