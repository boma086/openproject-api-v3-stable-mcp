 ...
 */
export const _links1Storage = z.lazy(() => {
  return z.object({
...
**Resource**: Storage
 * @typedef  {_Links1Storage} _links1Storage - The storage resource of the linked file.
 ...
 */
export type _Links1Storage = z.infer<typeof _links1Storage>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _links1StorageResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _links1StorageRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
