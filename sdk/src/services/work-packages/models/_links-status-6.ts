 ...
 */
export const _linksStatus6 = z.lazy(() => {
  return z.object({
...
**Resource**: Status
 * @typedef  {_LinksStatus6} _linksStatus6 - The current status of the work package
 ...
 */
export type _LinksStatus6 = z.infer<typeof _linksStatus6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
