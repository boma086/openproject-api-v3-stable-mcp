 ...
 */
export const _linksStatus7 = z.lazy(() => {
  return z.object({
...
**Resource**: Status
 * @typedef  {_LinksStatus7} _linksStatus7 - The current status of the work package

**Resource**: Status - The current status of the work package
 ...
 */
export type _LinksStatus7 = z.infer<typeof _linksStatus7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
