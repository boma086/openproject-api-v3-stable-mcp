 ...
 */
export const _linksCategory3 = z.lazy(() => {
  return z.object({
...
**Resource**: Category
 * @typedef  {_LinksCategory3} _linksCategory3 - The category of the work package
 ...
 */
export type _LinksCategory3 = z.infer<typeof _linksCategory3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
