 ...
 */
export const _linksSelf58 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf58} _linksSelf58 - The available assignees collection

**Resource**: AvailableAssigneesCollection - The available assignees collection
 ...
 */
export type _LinksSelf58 = z.infer<typeof _linksSelf58>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf58Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf58Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
