 ...
 */
export const _linksProject13 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject13} _linksProject13 - The project to which the work package belongs

**Resource**: Project - The project to which the work package belongs
 ...
 */
export type _LinksProject13 = z.infer<typeof _linksProject13>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject13Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject13Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
