 ...
 */
export const _linksLock2 = z.lazy(() => {
  return z.object({
...
- User is not locked
- `admin`
 * @typedef  {_LinksLock2} _linksLock2 - Restrict the user from logging in and performing any actions.
 ...
 */
export type _LinksLock2 = z.infer<typeof _linksLock2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLock2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLock2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
