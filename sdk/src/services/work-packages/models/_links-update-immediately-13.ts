 ...
 */
export const _linksUpdateImmediately13 = z.lazy(() => {
  return z.object({
...
- `admin`
 * @typedef  {_LinksUpdateImmediately13} _linksUpdateImmediately13 - A link to update the user resource.
 ...
 */
export type _LinksUpdateImmediately13 = z.infer<typeof _linksUpdateImmediately13>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately13Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately13Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
