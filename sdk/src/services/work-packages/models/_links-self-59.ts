 ...
 */
export const _linksSelf59 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf59} _linksSelf59 - This file links collection

**Resource**: FileLinkCollectionReadModel - This file links collection
 ...
 */
export type _LinksSelf59 = z.infer<typeof _linksSelf59>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf59Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf59Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
