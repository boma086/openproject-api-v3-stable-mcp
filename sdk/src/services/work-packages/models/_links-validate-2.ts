 ...
 */
export const _linksValidate2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksValidate2} _linksValidate2 - The endpoint for validating the request bodies. Often referring to this very form endpoint. - The endpoint for validating the request bodies. Often referring to this very form endpoint.
 ...
 */
export type _LinksValidate2 = z.infer<typeof _linksValidate2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksValidate2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksValidate2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
