 ...
 */
export const _linksAssignee4 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAssignee4} _linksAssignee4 - The person that is intended to work on the work package
 ...
 */
export type _LinksAssignee4 = z.infer<typeof _linksAssignee4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAssignee4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAssignee4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
