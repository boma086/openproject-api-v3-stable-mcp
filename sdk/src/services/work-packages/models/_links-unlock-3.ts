 ...
 */
export const _linksUnlock3 = z.lazy(() => {
  return z.object({
...
- User is not locked
- `admin`
 * @typedef  {_LinksUnlock3} _linksUnlock3 - Allow a locked user to login and act again.

# Conditions

- User is not locked
- `admin` - Allow a locked user to login and act again.
 ...
 */
export type _LinksUnlock3 = z.infer<typeof _linksUnlock3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnlock3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnlock3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
