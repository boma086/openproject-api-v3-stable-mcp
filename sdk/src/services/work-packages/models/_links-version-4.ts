 ...
 */
export const _linksVersion4 = z.lazy(() => {
  return z.object({
...
**Resource**: Version
 * @typedef  {_LinksVersion4} _linksVersion4 - The version associated to the work package
 ...
 */
export type _LinksVersion4 = z.infer<typeof _linksVersion4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
