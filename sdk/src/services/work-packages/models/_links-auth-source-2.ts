 ...
 */
export const _linksAuthSource2 = z.lazy(() => {
  return z.object({
...
- `admin`
 * @typedef  {_LinksAuthSource2} _linksAuthSource2 - Permanently remove a user from the instance
 ...
 */
export type _LinksAuthSource2 = z.infer<typeof _linksAuthSource2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthSource2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthSource2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
