 ...
 */
export const _linksResponsible3 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksResponsible3} _linksResponsible3 - The person that is responsible for the overall outcome
 ...
 */
export type _LinksResponsible3 = z.infer<typeof _linksResponsible3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
