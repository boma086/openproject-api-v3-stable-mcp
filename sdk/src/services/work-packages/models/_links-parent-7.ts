 ...
 */
export const _linksParent7 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent7} _linksParent7 - Parent work package
 ...
 */
export type _LinksParent7 = z.infer<typeof _linksParent7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
