 ...
 */
export const _linksAuthSource3 = z.lazy(() => {
  return z.object({
...
- `admin`
 * @typedef  {_LinksAuthSource3} _linksAuthSource3 - Permanently remove a user from the instance
 ...
 */
export type _LinksAuthSource3 = z.infer<typeof _linksAuthSource3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthSource3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthSource3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
