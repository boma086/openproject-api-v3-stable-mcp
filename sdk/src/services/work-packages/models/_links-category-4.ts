 ...
 */
export const _linksCategory4 = z.lazy(() => {
  return z.object({
...
**Resource**: Category
 * @typedef  {_LinksCategory4} _linksCategory4 - The category of the work package
 ...
 */
export type _LinksCategory4 = z.infer<typeof _linksCategory4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
