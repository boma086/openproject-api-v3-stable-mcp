 ...
 */
export const _linksCreator3 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksCreator3} _linksCreator3 - The person that created the reminder

**Resource**: User - The person that created the reminder
 ...
 */
export type _LinksCreator3 = z.infer<typeof _linksCreator3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreator3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreator3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
