 ...
 */
export const _linksType5 = z.lazy(() => {
  return z.object({
...
**Resource**: Type
 * @typedef  {_LinksType5} _linksType5 - The type of the work package
 ...
 */
export type _LinksType5 = z.infer<typeof _linksType5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
