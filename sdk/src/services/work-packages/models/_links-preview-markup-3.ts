 ...
 */
export const _linksPreviewMarkup3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksPreviewMarkup3} _linksPreviewMarkup3 - Renders a markup preview for the work package form. - Renders a markup preview for the work package form.
 ...
 */
export type _LinksPreviewMarkup3 = z.infer<typeof _linksPreviewMarkup3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviewMarkup3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviewMarkup3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
