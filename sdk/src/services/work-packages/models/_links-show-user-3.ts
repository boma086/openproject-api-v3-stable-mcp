 ...
 */
export const _linksShowUser3 = z.lazy(() => {
  return z.object({
...
- User is not `locked`
 * @typedef  {_LinksShowUser3} _linksShowUser3 - A relative path to show the user in the web application.
 ...
 */
export type _LinksShowUser3 = z.infer<typeof _linksShowUser3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
