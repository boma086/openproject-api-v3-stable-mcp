 ...
 */
export const _linksPriority4 = z.lazy(() => {
  return z.object({
...
**Resource**: Priority
 * @typedef  {_LinksPriority4} _linksPriority4 - The priority of the work package
 ...
 */
export type _LinksPriority4 = z.infer<typeof _linksPriority4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
