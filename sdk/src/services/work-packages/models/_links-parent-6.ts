 ...
 */
export const _linksParent6 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent6} _linksParent6 - Parent work package
 ...
 */
export type _LinksParent6 = z.infer<typeof _linksParent6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
