 ...
 */
export const storageUrl = z.lazy(() => {
  return z.object({
...
**Resource**: N/A
 * @typedef  {StorageUrl} storageUrl - The storage url the file link references to.

**Resource**: N/A - The storage url the file link references to.
 ...
 */
export type StorageUrl = z.infer<typeof storageUrl>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const storageUrlResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const storageUrlRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
