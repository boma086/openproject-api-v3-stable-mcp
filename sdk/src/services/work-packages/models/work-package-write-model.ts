...
import {
  ...
  workPackageWriteModelDescription,
  workPackageWriteModelDescriptionRequest,
  workPackageWriteModelDescriptionResponse,
} from './work-package-write-model-description';
import {
  WorkPackageWriteModelLinks,
  workPackageWriteModelLinks,
  workPackageWriteModelLinksRequest,
  workPackageWriteModelLinksResponse,
} from './work-package-write-model-links';

/**
 * The shape of the model inside the application code - what the users use
 */
export const workPackageWriteModel = z.lazy(() => {
  return z.object({
    subject: z.string().optional(),
    description: workPackageWriteModelDescription.optional(),
    ...
    _links: workPackageWriteModelLinks.optional(),
  });
});
 ...
 * @typedef  {WorkPackageWriteModel} workPackageWriteModel - This model is used for creating and updating work packages. It can also be used for validation against the work
package form endpoints. - This model is used for creating and updating work packages. It can also be used for validation against the work
package form endpoints.
 * @property {string} - Work package subject
 * @property {WorkPackageWriteModelDescription} - The work package description
 ...
 * @property {WorkPackageWriteModelLinks} 
 */
export type WorkPackageWriteModel = z.infer<typeof workPackageWriteModel>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const workPackageWriteModelResponse = z.lazy(() => {
  return z
    .object({
      subject: z.string().optional(),
      description: workPackageWriteModelDescriptionResponse.optional(),
      scheduleManually: z.boolean().optional(),
      startDate: z.string().optional().nullable(),
      dueDate: z.string().optional().nullable(),
      estimatedTime: z.string().optional().nullable(),
      duration: z.string().optional().nullable(),
      ignoreNonWorkingDays: z.boolean().optional(),
      _links: workPackageWriteModelLinksResponse.optional(),
    })
    .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const workPackageWriteModelRequest = z.lazy(() => {
  return z
    .object({
      subject: z.string().optional(),
      description: workPackageWriteModelDescriptionRequest.optional(),
      scheduleManually: z.boolean().optional(),
      startDate: z.string().optional().nullable(),
      dueDate: z.string().optional().nullable(),
      estimatedTime: z.string().optional().nullable(),
      duration: z.string().optional().nullable(),
      ignoreNonWorkingDays: z.boolean().optional(),
      _links: workPackageWriteModelLinksRequest.optional(),
    })
    .transform((data) => ({
      subject: data['subject'],
      description: data['description'],
