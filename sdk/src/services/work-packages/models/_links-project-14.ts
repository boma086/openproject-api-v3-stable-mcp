 ...
 */
export const _linksProject14 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject14} _linksProject14 - The project to which the work package belongs
 ...
 */
export type _LinksProject14 = z.infer<typeof _linksProject14>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject14Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject14Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
