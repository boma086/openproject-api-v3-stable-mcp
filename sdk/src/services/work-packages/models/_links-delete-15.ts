 ...
 */
export const _linksDelete15 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete15} _linksDelete15 - Permanently remove a user from the instance
 ...
 */
export type _LinksDelete15 = z.infer<typeof _linksDelete15>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete15Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete15Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
