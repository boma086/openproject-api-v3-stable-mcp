 ...
 */
export const collectionLinksSelf = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {CollectionLinksSelf} collectionLinksSelf - This collection resource.
 ...
 */
export type CollectionLinksSelf = z.infer<typeof collectionLinksSelf>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const collectionLinksSelfResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const collectionLinksSelfRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
