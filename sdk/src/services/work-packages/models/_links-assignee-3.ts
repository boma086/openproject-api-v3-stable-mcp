 ...
 */
export const _linksAssignee3 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAssignee3} _linksAssignee3 - The person that is intended to work on the work package
 ...
 */
export type _LinksAssignee3 = z.infer<typeof _linksAssignee3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAssignee3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAssignee3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
