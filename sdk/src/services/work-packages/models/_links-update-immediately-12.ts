 ...
 */
export const _linksUpdateImmediately12 = z.lazy(() => {
  return z.object({
...
- `admin`
 * @typedef  {_LinksUpdateImmediately12} _linksUpdateImmediately12 - A link to update the user resource.

# Conditions

- `admin` - A link to update the user resource.
 ...
 */
export type _LinksUpdateImmediately12 = z.infer<typeof _linksUpdateImmediately12>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately12Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately12Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
