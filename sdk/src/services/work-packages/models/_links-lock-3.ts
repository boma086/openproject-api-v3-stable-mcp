 ...
 */
export const _linksLock3 = z.lazy(() => {
  return z.object({
...
- User is not locked
- `admin`
 * @typedef  {_LinksLock3} _linksLock3 - Restrict the user from logging in and performing any actions.

# Conditions

- User is not locked
- `admin` - Restrict the user from logging in and performing any actions.
 ...
 */
export type _LinksLock3 = z.infer<typeof _linksLock3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLock3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLock3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
