 ...
 */
export const _linksUnlock2 = z.lazy(() => {
  return z.object({
...
- User is not locked
- `admin`
 * @typedef  {_LinksUnlock2} _linksUnlock2 - Allow a locked user to login and act again.
 ...
 */
export type _LinksUnlock2 = z.infer<typeof _linksUnlock2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnlock2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnlock2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
