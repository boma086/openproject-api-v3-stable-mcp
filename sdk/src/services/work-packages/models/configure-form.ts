 ...
 */
export const configureForm = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {ConfigureForm} configureForm - Link to the HTML page for the form configuration. - Link to the HTML page for the form configuration.
 ...
 */
export type ConfigureForm = z.infer<typeof configureForm>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const configureFormResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const configureFormRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
