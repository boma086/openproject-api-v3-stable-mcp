 ...
 */
export const _linksResponsible4 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksResponsible4} _linksResponsible4 - The person that is responsible for the overall outcome

**Resource**: User - The person that is responsible for the overall outcome
 ...
 */
export type _LinksResponsible4 = z.infer<typeof _linksResponsible4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
