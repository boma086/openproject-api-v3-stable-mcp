 ...
 */
export const _linksType6 = z.lazy(() => {
  return z.object({
...
**Resource**: Type
 * @typedef  {_LinksType6} _linksType6 - The type of the work package

**Resource**: Type - The type of the work package
 ...
 */
export type _LinksType6 = z.infer<typeof _linksType6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksType6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
