 ...
 */
export const _linksDelete14 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete14} _linksDelete14 - Permanently remove a user from the instance
 ...
 */
export type _LinksDelete14 = z.infer<typeof _linksDelete14>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete14Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete14Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
