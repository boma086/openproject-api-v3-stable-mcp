 ...
 */
export const _linksShowUser4 = z.lazy(() => {
  return z.object({
...
- User is not `locked`
 * @typedef  {_LinksShowUser4} _linksShowUser4 - A relative path to show the user in the web application.
 ...
 */
export type _LinksShowUser4 = z.infer<typeof _linksShowUser4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
