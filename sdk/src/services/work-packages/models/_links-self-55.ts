 ...
 */
export const _linksSelf55 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf55} _linksSelf55 - The work package collection

**Resource**: WorkPackageCollection - The work package collection
 ...
 */
export type _LinksSelf55 = z.infer<typeof _linksSelf55>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf55Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf55Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
