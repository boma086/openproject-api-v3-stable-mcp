 ...
 */
export const _linksSelf57 = z.lazy(() => {
  return z.object({
...
**Resource** : Form
 * @typedef  {_LinksSelf57} _linksSelf57 - This form endpoint

**Resource** : Form - This form endpoint
 ...
 */
export type _LinksSelf57 = z.infer<typeof _linksSelf57>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf57Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf57Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
