 ...
 */
export const _linksPriority3 = z.lazy(() => {
  return z.object({
...
**Resource**: Priority
 * @typedef  {_LinksPriority3} _linksPriority3 - The priority of the work package
 ...
 */
export type _LinksPriority3 = z.infer<typeof _linksPriority3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
