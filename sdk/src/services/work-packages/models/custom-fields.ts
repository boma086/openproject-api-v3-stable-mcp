 ...
 */
export const customFields = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {CustomFields} customFields - Link to the HTML page for the custom field definitions. - Link to the HTML page for the custom field definitions.
 ...
 */
export const customFieldsResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const customFieldsRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
