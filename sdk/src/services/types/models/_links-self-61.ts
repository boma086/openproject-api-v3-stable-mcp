 ...
 */
export const _linksSelf61 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf61} _linksSelf61 - The types collection

**Resource**: TypesCollection - The types collection
 ...
 */
export type _LinksSelf61 = z.infer<typeof _linksSelf61>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf61Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf61Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
