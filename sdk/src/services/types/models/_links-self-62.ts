 ...
 */
export const _linksSelf62 = z.lazy(() => {
  return z.object({
...
**Resource**: Type
 * @typedef  {_LinksSelf62} _linksSelf62 - This type
 ...
 */
export type _LinksSelf62 = z.infer<typeof _linksSelf62>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf62Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf62Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
