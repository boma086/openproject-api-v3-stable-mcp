 ...
 */
export const _linksChangeSize4 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksChangeSize4} _linksChangeSize4 - The notification collection with another size

**Resource**: NotificationCollectionModel - The notification collection with another size
 ...
 */
export type _LinksChangeSize4 = z.infer<typeof _linksChangeSize4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
