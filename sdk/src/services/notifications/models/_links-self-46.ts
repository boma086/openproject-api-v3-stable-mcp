 ...
 */
export const _linksSelf46 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf46} _linksSelf46 - This notification collection

**Resource**: NotificationCollectionModel - This notification collection
 ...
 */
export type _LinksSelf46 = z.infer<typeof _linksSelf46>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf46Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf46Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
