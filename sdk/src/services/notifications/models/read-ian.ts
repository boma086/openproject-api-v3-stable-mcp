 ...
 * @typedef  {ReadIan} readIan - Request to mark the notification as read. Only available if the notification is currently unread. - Request to mark the notification as read. Only available if the notification is currently unread.
 ...
 */
export type ReadIan = z.infer<typeof readIan>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const readIanResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const readIanRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
