 ...
 */
export const _linksSelf48 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf48} _linksSelf48 - This notification

**Resource**: Notification - This notification
 ...
 */
export type _LinksSelf48 = z.infer<typeof _linksSelf48>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf48Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf48Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
