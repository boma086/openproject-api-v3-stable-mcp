 ...
 */
export const _linksProject12 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject12} _linksProject12 - The project the notification originated in

**Resource**: Project - The project the notification originated in
 ...
 */
export type _LinksProject12 = z.infer<typeof _linksProject12>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject12Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject12Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
