 ...
 */
export const _linksSchema4 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSchema4} _linksSchema4 - The schema describing the key - value pair.

**Resource**: Schema - The schema describing the key - value pair.
 ...
 */
export type _LinksSchema4 = z.infer<typeof _linksSchema4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
