 ...
 */
export const _linksSelf47 = z.lazy(() => {
  return z.object({
...
**Resource**: Storage
 * @typedef  {_LinksSelf47} _linksSelf47 - This key - value pair.

**Resource**: Storage - This key - value pair.
 ...
 */
export type _LinksSelf47 = z.infer<typeof _linksSelf47>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf47Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf47Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
