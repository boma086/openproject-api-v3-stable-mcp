 ...
 */
export const _linksDetails = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDetails} _linksDetails - A list of objects including detailed information about the notification. The contents of
and type of this can vary widely between different notification reasons.

**Resource**: Polymorphic (e.g. Values::Property) - A list of objects including detailed information about the notification. The contents of
and type of this can vary widely between different notification reasons.
 ...
 */
export type _LinksDetails = z.infer<typeof _linksDetails>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDetailsResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDetailsRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
