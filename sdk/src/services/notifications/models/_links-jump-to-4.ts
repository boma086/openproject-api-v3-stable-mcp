 ...
 */
export const _linksJumpTo4 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksJumpTo4} _linksJumpTo4 - The notification collection at another offset

**Resource**: NotificationCollectionModel - The notification collection at another offset
 ...
 */
export type _LinksJumpTo4 = z.infer<typeof _linksJumpTo4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
