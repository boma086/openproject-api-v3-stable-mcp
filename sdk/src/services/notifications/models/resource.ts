 ...
 * @typedef  {Resource} resource - The linked resource of the notification, if any.

**Resource**: Polymorphic - The linked resource of the notification, if any.
 ...
 */
export const resourceResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const resourceRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
