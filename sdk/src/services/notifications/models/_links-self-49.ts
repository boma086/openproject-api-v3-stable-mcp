 ...
 */
export const _linksSelf49 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSelf49} _linksSelf49 - This schema
 ...
 */
export type _LinksSelf49 = z.infer<typeof _linksSelf49>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf49Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf49Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
