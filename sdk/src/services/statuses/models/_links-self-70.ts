 ...
 */
export const _linksSelf70 = z.lazy(() => {
  return z.object({
...
**Resource**: Status
 * @typedef  {_LinksSelf70} _linksSelf70 - This status
 ...
 */
export type _LinksSelf70 = z.infer<typeof _linksSelf70>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf70Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf70Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
