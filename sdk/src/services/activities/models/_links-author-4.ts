 ...
 */
export const _linksAuthor4 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAuthor4} _linksAuthor4 - The user who uploaded the attachment
 ...
 */
export type _LinksAuthor4 = z.infer<typeof _linksAuthor4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
