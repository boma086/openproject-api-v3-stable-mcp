 ...
 */
export const _linksUpdateImmediately1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately1} _linksUpdateImmediately1 - Directly perform edits on a work package
 ...
 */
export type _LinksUpdateImmediately1 = z.infer<typeof _linksUpdateImmediately1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
