 ...
 */
export const _linksDownloadLocation2 = z.lazy(() => {
  return z.object({
...
**Resource**: -
 * @typedef  {_LinksDownloadLocation2} _linksDownloadLocation2 - Direct download link to the attachment
 ...
 */
export type _LinksDownloadLocation2 = z.infer<typeof _linksDownloadLocation2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDownloadLocation2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDownloadLocation2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
