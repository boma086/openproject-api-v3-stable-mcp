 ...
 */
export const _linksContainer1 = z.lazy(() => {
  return z.object({
...
**Resource**: Anything
 * @typedef  {_LinksContainer1} _linksContainer1 - The object (e.g. WorkPackage) housing the attachment
 ...
 */
export type _LinksContainer1 = z.infer<typeof _linksContainer1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
