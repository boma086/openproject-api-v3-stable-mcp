 ...
 */
export const _linksPreviewMarkup1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksPreviewMarkup1} _linksPreviewMarkup1 - Post markup (in markdown) here to receive an HTML-rendered response - Post markup (in markdown) here to receive an HTML-rendered response
 ...
 */
export type _LinksPreviewMarkup1 = z.infer<typeof _linksPreviewMarkup1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviewMarkup1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPreviewMarkup1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
