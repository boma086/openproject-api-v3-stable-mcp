 ...
 */
export const _linksUpdate1 = z.lazy(() => {
  return z.object({
...
/**
 * Form endpoint that aids in preparing and performing edits on a work package

# Conditions

**Permission**: edit work package
 * @typedef  {_LinksUpdate1} _linksUpdate1 - Form endpoint that aids in preparing and performing edits on a work package

# Conditions

**Permission**: edit work package - Form endpoint that aids in preparing and performing edits on a work package
 ...
 */
export type _LinksUpdate1 = z.infer<typeof _linksUpdate1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
