 ...
 */
export const _linksUnwatch1 = z.lazy(() => {
  return z.object({
...
logged in; watching
 * @typedef  {_LinksUnwatch1} _linksUnwatch1 - Remove current user from WP watchers

# Conditions

logged in; watching - Remove current user from WP watchers
 ...
 */
export type _LinksUnwatch1 = z.infer<typeof _linksUnwatch1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnwatch1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUnwatch1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
