 ...
 */
export const _linksResponsible1 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksResponsible1} _linksResponsible1 - The person that is responsible for the overall outcome
 ...
 */
export type _LinksResponsible1 = z.infer<typeof _linksResponsible1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksResponsible1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
