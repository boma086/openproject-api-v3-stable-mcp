 ...
 */
export const _linksRevisions1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksRevisions1} _linksRevisions1 - Revisions that are referencing the work package

**Resource**: Revision

# Conditions

**Permission** view changesets - Revisions that are referencing the work package
 ...
 */
export type _LinksRevisions1 = z.infer<typeof _linksRevisions1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRevisions1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRevisions1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
