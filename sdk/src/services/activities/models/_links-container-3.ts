 ...
 */
export const _linksContainer3 = z.lazy(() => {
  return z.object({
...
**Resource**: Anything
 * @typedef  {_LinksContainer3} _linksContainer3 - The object (e.g. WorkPackage) housing the attachment
 ...
 */
export type _LinksContainer3 = z.infer<typeof _linksContainer3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
