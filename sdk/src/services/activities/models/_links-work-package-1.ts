 ...
 */
export const _linksWorkPackage1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksWorkPackage1} _linksWorkPackage1 - The work package this activity belongs to

**Resource**: WorkPackage - The work package this activity belongs to
 ...
 */
export type _LinksWorkPackage1 = z.infer<typeof _linksWorkPackage1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackage1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackage1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
