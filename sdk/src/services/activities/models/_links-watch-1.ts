 ...
 */
export const _linksWatch1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksWatch1} _linksWatch1 - Add current user to WP watchers
 ...
 */
export type _LinksWatch1 = z.infer<typeof _linksWatch1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatch1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatch1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
