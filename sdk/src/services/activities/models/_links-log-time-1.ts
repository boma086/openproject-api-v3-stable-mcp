 ...
 */
export const _linksLogTime1 = z.lazy(() => {
  return z.object({
...
/**
 * Create time entries on the work package

# Conditions

**Permission**: log_time or log_own_time
 * @typedef  {_LinksLogTime1} _linksLogTime1 - Create time entries on the work package

# Conditions

**Permission**: log_time or log_own_time - Create time entries on the work package
 ...
 */
export type _LinksLogTime1 = z.infer<typeof _linksLogTime1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLogTime1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksLogTime1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
