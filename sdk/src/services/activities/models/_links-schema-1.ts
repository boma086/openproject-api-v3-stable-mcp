 ...
 */
export const _linksSchema1 = z.lazy(() => {
  return z.object({
...
**Resource**: Schema
 * @typedef  {_LinksSchema1} _linksSchema1 - The schema of this work package
 ...
 */
export type _LinksSchema1 = z.infer<typeof _linksSchema1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSchema1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
