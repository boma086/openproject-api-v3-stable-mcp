 ...
 */
export const _linksSelf8 = z.lazy(() => {
  return z.object({
...
**Resource**: Attachment
 * @typedef  {_LinksSelf8} _linksSelf8 - This attachment
 ...
 */
export type _LinksSelf8 = z.infer<typeof _linksSelf8>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf8Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf8Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
