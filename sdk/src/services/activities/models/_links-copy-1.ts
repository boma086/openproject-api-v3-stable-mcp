 ...
 */
export const _linksCopy1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCopy1} _linksCopy1 - Link to page for copying this work package
 ...
 */
export type _LinksCopy1 = z.infer<typeof _linksCopy1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCopy1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCopy1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
