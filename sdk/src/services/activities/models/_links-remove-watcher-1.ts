 ...
 */
export const _linksRemoveWatcher1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksRemoveWatcher1} _linksRemoveWatcher1 - Remove any user from WP watchers

# Conditions

**Permission**: delete watcher - Remove any user from WP watchers
 ...
 */
export type _LinksRemoveWatcher1 = z.infer<typeof _linksRemoveWatcher1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRemoveWatcher1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRemoveWatcher1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
