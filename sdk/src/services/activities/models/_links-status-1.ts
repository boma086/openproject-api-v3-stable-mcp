 ...
 */
export const _linksStatus1 = z.lazy(() => {
  return z.object({
...
**Resource**: Status
 * @typedef  {_LinksStatus1} _linksStatus1 - The current status of the work package
 ...
 */
export type _LinksStatus1 = z.infer<typeof _linksStatus1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStatus1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
