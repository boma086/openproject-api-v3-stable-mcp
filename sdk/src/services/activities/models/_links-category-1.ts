 ...
 */
export const _linksCategory1 = z.lazy(() => {
  return z.object({
...
**Resource**: Category
 * @typedef  {_LinksCategory1} _linksCategory1 - The category of the work package
 ...
 */
export type _LinksCategory1 = z.infer<typeof _linksCategory1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategory1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
