 ...
 */
export const _linksAddWatcher1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddWatcher1} _linksAddWatcher1 - Add any user to WP watchers
 ...
 */
export type _LinksAddWatcher1 = z.infer<typeof _linksAddWatcher1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddWatcher1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddWatcher1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
