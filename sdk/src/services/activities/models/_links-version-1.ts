 ...
 */
export const _linksVersion1 = z.lazy(() => {
  return z.object({
...
**Resource**: Version
 * @typedef  {_LinksVersion1} _linksVersion1 - The version associated to the work package

**Resource**: Version - The version associated to the work package
 ...
 */
export type _LinksVersion1 = z.infer<typeof _linksVersion1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersion1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
