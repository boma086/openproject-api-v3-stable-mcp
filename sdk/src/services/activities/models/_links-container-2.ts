 ...
 */
export const _linksContainer2 = z.lazy(() => {
  return z.object({
...
**Resource**: Anything
 * @typedef  {_LinksContainer2} _linksContainer2 - The object (e.g. WorkPackage) housing the attachment

**Resource**: Anything - The object (e.g. WorkPackage) housing the attachment
 ...
 */
export type _LinksContainer2 = z.infer<typeof _linksContainer2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksContainer2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
