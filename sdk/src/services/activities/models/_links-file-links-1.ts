 ...
 */
export const _linksFileLinks1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksFileLinks1} _linksFileLinks1 - Gets the file link collection of this work package

# Conditions

**Permission**: view_file_links - Gets the file link collection of this work package
 ...
 */
export type _LinksFileLinks1 = z.infer<typeof _linksFileLinks1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksFileLinks1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksFileLinks1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
