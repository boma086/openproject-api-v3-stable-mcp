 ...
 */
export const _linksUpdate2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdate2} _linksUpdate2 - Update this activity - Update this activity
 ...
 */
export type _LinksUpdate2 = z.infer<typeof _linksUpdate2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
