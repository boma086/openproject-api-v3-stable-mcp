 ...
 */
export const _linksChildren1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksChildren1} _linksChildren1 - A visible child work package of the current work package.

**Resource**: WorkPackage

# Conditions

**Permission** view work packages - A visible child work package of the current work package.
 ...
 */
export type _LinksChildren1 = z.infer<typeof _linksChildren1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChildren1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChildren1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
