 ...
 */
export const _linksAddAttachment1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment1} _linksAddAttachment1 - Attach a file to the work package
 ...
 */
export type _LinksAddAttachment1 = z.infer<typeof _linksAddAttachment1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
