 ...
 */
export const _linksAncestors1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAncestors1} _linksAncestors1 - A visible ancestor work package of the current work package.

**Resource**: WorkPackage

# Conditions

**Permission** view work packages - A visible ancestor work package of the current work package.
 ...
 */
export type _LinksAncestors1 = z.infer<typeof _linksAncestors1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
