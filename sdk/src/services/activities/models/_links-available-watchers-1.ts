 ...
 */
export const _linksAvailableWatchers1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAvailableWatchers1} _linksAvailableWatchers1 - All users that can be added to the work package as watchers.

**Resource**: User

# Conditions

**Permission** add work package watchers - All users that can be added to the work package as watchers.
 ...
 */
export type _LinksAvailableWatchers1 = z.infer<typeof _linksAvailableWatchers1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableWatchers1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAvailableWatchers1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
