 ...
 */
export const _linksSelf3 = z.lazy(() => {
  return z.object({
...
**Resource**: Attachment
 * @typedef  {_LinksSelf3} _linksSelf3 - This attachment

**Resource**: Attachment - This attachment
 ...
 */
export type _LinksSelf3 = z.infer<typeof _linksSelf3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
