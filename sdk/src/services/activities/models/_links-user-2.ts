 ...
 */
export const _linksUser2 = z.lazy(() => {
  return z.object({
...
**Resource**: Principal
 * @typedef  {_LinksUser2} _linksUser2 - The user who created this activity

**Resource**: Principal - The user who created this activity
 ...
 */
export type _LinksUser2 = z.infer<typeof _linksUser2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUser2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUser2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
