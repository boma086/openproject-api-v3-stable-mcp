 ...
 */
export const _linksCustomActions1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCustomActions1} _linksCustomActions1 - A predefined action that can be applied to the work package.
 ...
 */
export type _LinksCustomActions1 = z.infer<typeof _linksCustomActions1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCustomActions1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCustomActions1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
