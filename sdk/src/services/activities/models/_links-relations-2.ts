 ...
 */
export const _linksRelations2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksRelations2} _linksRelations2 - Relations this work package is involved in

**Resource**: Relation

# Conditions

**Permission** view work packages - Relations this work package is involved in
 ...
 */
export type _LinksRelations2 = z.infer<typeof _linksRelations2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRelations2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRelations2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
