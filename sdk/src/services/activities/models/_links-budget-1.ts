 ...
 */
export const _linksBudget1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksBudget1} _linksBudget1 - The budget this work package is associated to
 ...
 */
export type _LinksBudget1 = z.infer<typeof _linksBudget1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksBudget1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksBudget1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
