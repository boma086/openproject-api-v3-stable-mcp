 ...
 */
export const _linksMove1 = z.lazy(() => {
  return z.object({
...
/**
 * Link to page for moving this work package

# Conditions

**Permission**: move_work_packages
 * @typedef  {_LinksMove1} _linksMove1 - Link to page for moving this work package

# Conditions

**Permission**: move_work_packages - Link to page for moving this work package
 ...
 */
export type _LinksMove1 = z.infer<typeof _linksMove1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMove1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMove1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
