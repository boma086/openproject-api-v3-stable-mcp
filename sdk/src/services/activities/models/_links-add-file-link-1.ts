 ...
 */
export const _linksAddFileLink1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddFileLink1} _linksAddFileLink1 - Add a file link to the work package

# Conditions

**Permission**: manage_file_links - Add a file link to the work package
 ...
 */
export type _LinksAddFileLink1 = z.infer<typeof _linksAddFileLink1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddFileLink1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddFileLink1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
