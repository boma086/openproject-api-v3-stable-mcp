 ...
 */
export const _linksSelf6 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf6} _linksSelf6 - The attachments collection
 ...
 */
export type _LinksSelf6 = z.infer<typeof _linksSelf6>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf6Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf6Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
