 ...
 */
export const _linksSelf7 = z.lazy(() => {
  return z.object({
...
**Resource**: Attachment
 * @typedef  {_LinksSelf7} _linksSelf7 - This attachment
 ...
 */
export type _LinksSelf7 = z.infer<typeof _linksSelf7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
