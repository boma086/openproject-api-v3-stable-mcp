 ...
 */
export const _linksWatchers1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksWatchers1} _linksWatchers1 - All users that are currently watching this work package
 ...
 */
export type _LinksWatchers1 = z.infer<typeof _linksWatchers1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatchers1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWatchers1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
