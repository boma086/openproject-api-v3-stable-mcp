 ...
 */
export const _linksAddComment1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddComment1} _linksAddComment1 - Post comment to WP
 ...
 */
export type _LinksAddComment1 = z.infer<typeof _linksAddComment1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddComment1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddComment1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
