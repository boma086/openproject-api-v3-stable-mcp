 ...
 */
export const _linksAddAttachment2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment2} _linksAddAttachment2 - Attach a file to the activity

# Conditions

**Permissions**:
- `add_work_package_comments`
- for internal comments: `add_internal_comments` - Attach a file to the activity
 ...
 */
export type _LinksAddAttachment2 = z.infer<typeof _linksAddAttachment2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
