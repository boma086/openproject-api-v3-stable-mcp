 ...
 */
export const _linksDownloadLocation3 = z.lazy(() => {
  return z.object({
...
**Resource**: -
 * @typedef  {_LinksDownloadLocation3} _linksDownloadLocation3 - Direct download link to the attachment

**Resource**: - - Direct download link to the attachment
 ...
 */
export type _LinksDownloadLocation3 = z.infer<typeof _linksDownloadLocation3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDownloadLocation3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDownloadLocation3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
