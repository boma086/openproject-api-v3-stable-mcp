 ...
 */
export const _linksAddRelation1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddRelation1} _linksAddRelation1 - Adds a relation to this work package.
 ...
 */
export type _LinksAddRelation1 = z.infer<typeof _linksAddRelation1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddRelation1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddRelation1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
