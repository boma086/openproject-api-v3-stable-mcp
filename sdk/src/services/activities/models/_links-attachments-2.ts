 ...
 */
export const _linksAttachments2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAttachments2} _linksAttachments2 - The attachment collection of this activity

**Resource**: Attachments - The attachment collection of this activity
 ...
 */
export type _LinksAttachments2 = z.infer<typeof _linksAttachments2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
