 ...
 */
export const _linksPriority1 = z.lazy(() => {
  return z.object({
...
**Resource**: Priority
 * @typedef  {_LinksPriority1} _linksPriority1 - The priority of the work package

**Resource**: Priority - The priority of the work package
 ...
 */
export type _LinksPriority1 = z.infer<typeof _linksPriority1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPriority1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
