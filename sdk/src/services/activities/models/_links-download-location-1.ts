 ...
 */
export const _linksDownloadLocation1 = z.lazy(() => {
  return z.object({
...
**Resource**: -
 * @typedef  {_LinksDownloadLocation1} _linksDownloadLocation1 - Direct download link to the attachment
 ...
 */
export type _LinksDownloadLocation1 = z.infer<typeof _linksDownloadLocation1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDownloadLocation1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDownloadLocation1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
