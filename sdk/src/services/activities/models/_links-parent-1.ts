 ...
 */
export const _linksParent1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent1} _linksParent1 - Parent work package
 ...
 */
export type _LinksParent1 = z.infer<typeof _linksParent1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
