 ...
 */
export const _linksAttachments1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAttachments1} _linksAttachments1 - The files attached to this work package

**Resource**: Collection

# Conditions

- **Setting**: deactivate_work_package_attachments set to false in related project - The files attached to this work package
 ...
 */
export type _LinksAttachments1 = z.infer<typeof _linksAttachments1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
