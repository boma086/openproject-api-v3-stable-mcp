 ...
 */
export const _linksSelf5 = z.lazy(() => {
  return z.object({
...
**Resource**: Activity
 * @typedef  {_LinksSelf5} _linksSelf5 - This activity

**Resource**: Activity - This activity
 ...
 */
export type _LinksSelf5 = z.infer<typeof _linksSelf5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
