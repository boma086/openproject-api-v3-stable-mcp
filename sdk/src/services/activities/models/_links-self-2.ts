 ...
 */
export const _linksSelf2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf2} _linksSelf2 - The attachments collection

**Resource**: AttachmentsCollection - The attachments collection
 ...
 */
export type _LinksSelf2 = z.infer<typeof _linksSelf2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
