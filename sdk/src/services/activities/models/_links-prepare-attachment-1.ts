 ...
 */
export const _linksPrepareAttachment1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksPrepareAttachment1} _linksPrepareAttachment1 - Attach a file to the work package
 ...
 */
export type _LinksPrepareAttachment1 = z.infer<typeof _linksPrepareAttachment1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPrepareAttachment1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksPrepareAttachment1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
