 ...
 */
export const _linksProject1 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject1} _linksProject1 - The project to which the work package belongs
 ...
 */
export type _LinksProject1 = z.infer<typeof _linksProject1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
