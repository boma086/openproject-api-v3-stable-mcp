 ...
 */
export const _linksAuthor3 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAuthor3} _linksAuthor3 - The user who uploaded the attachment

**Resource**: User - The user who uploaded the attachment
 ...
 */
export type _LinksAuthor3 = z.infer<typeof _linksAuthor3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
