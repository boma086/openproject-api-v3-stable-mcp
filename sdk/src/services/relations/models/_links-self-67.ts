 ...
 */
export const _linksSelf67 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf67} _linksSelf67 - This relation collection

**Resource**: RelationCollectionReadModel - This relation collection
 ...
 */
export type _LinksSelf67 = z.infer<typeof _linksSelf67>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf67Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf67Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
