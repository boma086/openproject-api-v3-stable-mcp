 ...
 */
export const _linksSelf68 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf68} _linksSelf68 - This relation

**Resource**: Relation

# Conditions

**Permission**: view work packages - This relation
 ...
 */
export type _LinksSelf68 = z.infer<typeof _linksSelf68>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf68Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf68Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
