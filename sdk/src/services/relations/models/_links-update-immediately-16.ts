 ...
 */
export const _linksUpdateImmediately16 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately16} _linksUpdateImmediately16 - Updates the relation between two work packages

# Conditions

**Permission**: manage work package relations - Updates the relation between two work packages
 ...
 */
export type _LinksUpdateImmediately16 = z.infer<typeof _linksUpdateImmediately16>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately16Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately16Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
