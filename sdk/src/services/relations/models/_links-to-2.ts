 ...
 * @typedef  {_LinksTo2} _linksTo2 - The work package the relation ends in. Only available on relation creation, not on update.

**Resource**: WorkPackage

# Conditions

**Permission**: view work packages - The work package the relation ends in. Only available on relation creation, not on update.
 ...
 */
export type _LinksTo2 = z.infer<typeof _linksTo2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksTo2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksTo2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
