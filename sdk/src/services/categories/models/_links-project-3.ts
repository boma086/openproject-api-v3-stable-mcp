 ...
 */
export const _linksProject3 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject3} _linksProject3 - The project of this category

**Resource**: Project - The project of this category
 ...
 */
export type _LinksProject3 = z.infer<typeof _linksProject3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
