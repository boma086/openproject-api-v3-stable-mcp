 ...
 */
export const _linksSelf10 = z.lazy(() => {
  return z.object({
...
**Resource**: Category
 * @typedef  {_LinksSelf10} _linksSelf10 - This category
 ...
 */
export type _LinksSelf10 = z.infer<typeof _linksSelf10>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf10Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf10Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
