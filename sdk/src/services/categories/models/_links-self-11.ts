 ...
 */
export const _linksSelf11 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf11} _linksSelf11 - The categories collection

**Resource**: CategoriesCollection - The categories collection
 ...
 */
export type _LinksSelf11 = z.infer<typeof _linksSelf11>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf11Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf11Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
