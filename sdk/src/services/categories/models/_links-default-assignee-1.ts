 ...
 */
export const _linksDefaultAssignee1 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksDefaultAssignee1} _linksDefaultAssignee1 - Default assignee for work packages of this category

**Resource**: User - Default assignee for work packages of this category
 ...
 */
export type _LinksDefaultAssignee1 = z.infer<typeof _linksDefaultAssignee1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefaultAssignee1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefaultAssignee1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
