 ...
 */
export const _linksProject2 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject2} _linksProject2 - The project of this category
 ...
 */
export type _LinksProject2 = z.infer<typeof _linksProject2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
