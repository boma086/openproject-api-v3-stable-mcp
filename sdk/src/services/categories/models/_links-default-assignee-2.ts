 ...
 */
export const _linksDefaultAssignee2 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksDefaultAssignee2} _linksDefaultAssignee2 - Default assignee for work packages of this category
 ...
 */
export type _LinksDefaultAssignee2 = z.infer<typeof _linksDefaultAssignee2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefaultAssignee2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDefaultAssignee2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
