 ...
 */
export const _linksSelf12 = z.lazy(() => {
  return z.object({
...
**Resource**: Category
 * @typedef  {_LinksSelf12} _linksSelf12 - This category
 ...
 */
export type _LinksSelf12 = z.infer<typeof _linksSelf12>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf12Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf12Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
