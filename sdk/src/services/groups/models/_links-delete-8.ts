 ...
 */
export const _linksDelete8 = z.lazy(() => {
  return z.object({
...
- `admin`
 * @typedef  {_LinksDelete8} _linksDelete8 - An href to delete the group.

# Conditions:

- `admin` - An href to delete the group.
 ...
 */
export type _LinksDelete8 = z.infer<typeof _linksDelete8>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete8Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete8Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
