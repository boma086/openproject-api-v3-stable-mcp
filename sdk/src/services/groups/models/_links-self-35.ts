 ...
 */
export const _linksSelf35 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksSelf35} _linksSelf35 - This group collection

**Resource**: Collection - This group collection
 ...
 */
export type _LinksSelf35 = z.infer<typeof _linksSelf35>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf35Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf35Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
