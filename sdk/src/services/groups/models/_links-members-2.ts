 ...
 */
export const _linksMembers2 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksMembers2} _linksMembers2 - A new member for the group.

**Resource**: User - A new member for the group.
 ...
 */
export type _LinksMembers2 = z.infer<typeof _linksMembers2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMembers2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMembers2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
