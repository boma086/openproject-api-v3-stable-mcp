 ...
 */
export const _linksUpdateImmediately4 = z.lazy(() => {
  return z.object({
...
**Resource**: Group
 * @typedef  {_LinksUpdateImmediately4} _linksUpdateImmediately4 - An href to update the group.

# Conditions:

- `admin`

**Resource**: Group - An href to update the group.
 ...
 */
export type _LinksUpdateImmediately4 = z.infer<typeof _linksUpdateImmediately4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
