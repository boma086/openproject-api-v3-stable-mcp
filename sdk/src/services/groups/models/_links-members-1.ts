 ...
 */
export const _linksMembers1 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksMembers1} _linksMembers1 - A member of the group

# Conditions:

- user has permission `manage_members` in any project

**Resource**: User - A member of the group
 ...
 */
export type _LinksMembers1 = z.infer<typeof _linksMembers1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMembers1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMembers1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
