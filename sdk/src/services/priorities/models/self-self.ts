 ...
 * @typedef  {SelfSelf} selfSelf - This priority collection

**Resource**: PriorityCollectionModel - This priority collection
 ...
 */
export type SelfSelf = z.infer<typeof selfSelf>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const selfSelfResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const selfSelfRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
