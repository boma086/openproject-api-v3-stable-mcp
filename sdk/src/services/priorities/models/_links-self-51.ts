 ...
 */
export const _linksSelf51 = z.lazy(() => {
  return z.object({
...
**Resource**: Priority
 * @typedef  {_LinksSelf51} _linksSelf51 - This priority
 ...
 */
export type _LinksSelf51 = z.infer<typeof _linksSelf51>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf51Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf51Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
