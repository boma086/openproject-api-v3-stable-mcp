 ...
 */
export const showRevision = z.lazy(() => {
  return z.object({
...
**Resource**: -
 * @typedef  {ShowRevision} showRevision - A URL to the repository view (outside APIv3) showing this revision

**Resource**: - - A URL to the repository view (outside APIv3) showing this revision
 ...
 */
export type ShowRevision = z.infer<typeof showRevision>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const showRevisionResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const showRevisionRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
