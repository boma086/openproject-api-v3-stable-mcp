 ...
 */
export const _linksSelf69 = z.lazy(() => {
  return z.object({
...
**Resource**: Revision
 * @typedef  {_LinksSelf69} _linksSelf69 - This revision
 ...
 */
export type _LinksSelf69 = z.infer<typeof _linksSelf69>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf69Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf69Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
