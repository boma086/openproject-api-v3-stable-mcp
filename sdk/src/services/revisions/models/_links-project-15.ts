 ...
 */
export const _linksProject15 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject15} _linksProject15 - The project to which the revision belongs

**Resource**: Project - The project to which the revision belongs
 ...
 */
export type _LinksProject15 = z.infer<typeof _linksProject15>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject15Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject15Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
