 ...
 */
export const _linksAuthor8 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksAuthor8} _linksAuthor8 - The user that added this revision, if the authorName was mapped to a user in OpenProject

**Resource**: User - The user that added this revision, if the authorName was mapped to a user in OpenProject
 ...
 */
export type _LinksAuthor8 = z.infer<typeof _linksAuthor8>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor8Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAuthor8Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
