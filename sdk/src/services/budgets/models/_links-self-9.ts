 ...
 */
export const _linksSelf9 = z.lazy(() => {
  return z.object({
...
**Resource**: Budget
 * @typedef  {_LinksSelf9} _linksSelf9 - This budget

**Resource**: Budget - This budget
 ...
 */
export type _LinksSelf9 = z.infer<typeof _linksSelf9>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf9Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf9Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
