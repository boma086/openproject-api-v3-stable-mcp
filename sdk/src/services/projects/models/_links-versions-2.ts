 ...
 */
export const _linksVersions2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksVersions2} _linksVersions2 - Versions available in this project

**Resource**: Collection

# Conditions

**Permission**: view work packages or manage versions - Versions available in this project
 ...
 */
export type _LinksVersions2 = z.infer<typeof _linksVersions2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersions2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksVersions2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
