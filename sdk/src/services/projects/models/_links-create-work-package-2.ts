 ...
 */
export const _linksCreateWorkPackage2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCreateWorkPackage2} _linksCreateWorkPackage2 - Form endpoint that aids in preparing and creating a work package

# Conditions

**Permission**: add work packages - Form endpoint that aids in preparing and creating a work package
 ...
 */
export type _LinksCreateWorkPackage2 = z.infer<typeof _linksCreateWorkPackage2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackage2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackage2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
