 ...
 */
export const _linksParent5 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent5} _linksParent5 - Parent project of the project
 ...
 */
export type _LinksParent5 = z.infer<typeof _linksParent5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
