 ...
 */
export const _linksCreateWorkPackageImmediately2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksCreateWorkPackageImmediately2} _linksCreateWorkPackageImmediately2 - Directly creates a work package in the project
 ...
 */
export type _LinksCreateWorkPackageImmediately2 = z.infer<typeof _linksCreateWorkPackageImmediately2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackageImmediately2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCreateWorkPackageImmediately2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
