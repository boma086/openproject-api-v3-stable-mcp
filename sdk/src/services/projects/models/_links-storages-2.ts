 ...
 */
export const _linksStorages2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksStorages2} _linksStorages2 - The link to a storage that is active for this project.
 ...
 */
export type _LinksStorages2 = z.infer<typeof _linksStorages2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorages2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksStorages2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
