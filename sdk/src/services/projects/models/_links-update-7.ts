 ...
 */
export const _linksUpdate7 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdate7} _linksUpdate7 - Form endpoint that aids in updating this project
 ...
 */
export type _LinksUpdate7 = z.infer<typeof _linksUpdate7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdate7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
