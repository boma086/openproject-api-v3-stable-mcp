 ...
 */
export const _linksWorkPackages3 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksWorkPackages3} _linksWorkPackages3 - Work Packages of this project

**Resource**: Collection - Work Packages of this project
 ...
 */
export type _LinksWorkPackages3 = z.infer<typeof _linksWorkPackages3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackages3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackages3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
