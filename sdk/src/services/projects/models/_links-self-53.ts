 ...
 */
export const _linksSelf53 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksSelf53} _linksSelf53 - This project
 ...
 */
export type _LinksSelf53 = z.infer<typeof _linksSelf53>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf53Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf53Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
