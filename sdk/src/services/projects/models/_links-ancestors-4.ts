 ...
 */
export const _linksAncestors4 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksAncestors4} _linksAncestors4 - The link to an ancestor project.
 ...
 */
export type _LinksAncestors4 = z.infer<typeof _linksAncestors4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAncestors4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
