 ...
 */
export const _linksDelete13 = z.lazy(() => {
  return z.object({
...
**Permission**: admin
 * @typedef  {_LinksDelete13} _linksDelete13 - Delete this project

# Conditions

**Permission**: admin - Delete this project
 ...
 */
export type _LinksDelete13 = z.infer<typeof _linksDelete13>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete13Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete13Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
