 ...
 */
export const _linksProjectStorages2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksProjectStorages2} _linksProjectStorages2 - The project storage collection of this project.
 ...
 */
export type _LinksProjectStorages2 = z.infer<typeof _linksProjectStorages2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProjectStorages2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProjectStorages2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
