 ...
 */
export const _linksMemberships3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksMemberships3} _linksMemberships3 - Memberships in the  project

**Resource**: Collection

# Conditions

**Permission**: view members - Memberships in the  project
 ...
 */
export type _LinksMemberships3 = z.infer<typeof _linksMemberships3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMemberships3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMemberships3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
