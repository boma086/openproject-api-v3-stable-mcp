 ...
 */
export const _linksCategories2 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksCategories2} _linksCategories2 - Categories available in this project

**Resource**: Collection - Categories available in this project
 ...
 */
export type _LinksCategories2 = z.infer<typeof _linksCategories2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategories2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksCategories2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
