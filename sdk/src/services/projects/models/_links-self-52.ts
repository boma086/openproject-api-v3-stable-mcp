 ...
 */
export const _linksSelf52 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf52} _linksSelf52 - The project collection

**Resource**: ProjectCollection - The project collection
 ...
 */
export type _LinksSelf52 = z.infer<typeof _linksSelf52>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf52Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf52Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
