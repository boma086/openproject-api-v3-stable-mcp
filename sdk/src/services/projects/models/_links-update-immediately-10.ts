 ...
 */
export const _linksUpdateImmediately10 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately10} _linksUpdateImmediately10 - Directly update this project

# Conditions

**Permission**: edit project - Directly update this project
 ...
 */
export type _LinksUpdateImmediately10 = z.infer<typeof _linksUpdateImmediately10>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately10Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately10Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
