 ...
 */
export const _linksDelete7 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete7} _linksDelete7 - Deletes this grid resource. - Deletes this grid resource.
 ...
 */
export type _LinksDelete7 = z.infer<typeof _linksDelete7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
