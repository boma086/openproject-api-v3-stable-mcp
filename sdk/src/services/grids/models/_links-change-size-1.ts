 ...
 */
export const _linksChangeSize1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksChangeSize1} _linksChangeSize1 - Templated link for another page size.

**Resource**: Collection - Templated link for another page size.
 ...
 */
export type _LinksChangeSize1 = z.infer<typeof _linksChangeSize1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChangeSize1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
