 ...
 */
export const _linksJumpTo1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksJumpTo1} _linksJumpTo1 - Templated link to another page offset.

**Resource**: Collection - Templated link to another page offset.
 ...
 */
export type _LinksJumpTo1 = z.infer<typeof _linksJumpTo1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksJumpTo1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
