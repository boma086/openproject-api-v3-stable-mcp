 ...
 */
export const _linksUpdateImmediately3 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately3} _linksUpdateImmediately3 - Directly perform edits on this grid.

# Conditions

**Permission**: depends on the page the grid is defined for - Directly perform edits on this grid.
 ...
 */
export type _LinksUpdateImmediately3 = z.infer<typeof _linksUpdateImmediately3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
