 ...
 */
export const _linksAttachments5 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAttachments5} _linksAttachments5 - The attachment collection of this grid.

**Resource**: AttachmentCollection - The attachment collection of this grid.
 ...
 */
export type _LinksAttachments5 = z.infer<typeof _linksAttachments5>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments5Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments5Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
