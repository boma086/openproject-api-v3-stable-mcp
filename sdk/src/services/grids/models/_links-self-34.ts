 ...
 */
export const _linksSelf34 = z.lazy(() => {
  return z.object({
...
**Resource**: Grid
 * @typedef  {_LinksSelf34} _linksSelf34 - This grid.

**Resource**: Grid - This grid.
 ...
 */
export type _LinksSelf34 = z.infer<typeof _linksSelf34>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf34Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf34Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
