 ...
 */
export const _linksScope2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksScope2} _linksScope2 - The location where this grid is used, usually represented as a relative URL. - The location where this grid is used, usually represented as a relative URL.
 ...
 */
export type _LinksScope2 = z.infer<typeof _linksScope2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksScope2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksScope2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
