 ...
 */
export const _linksAddAttachment4 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment4} _linksAddAttachment4 - Link for adding an attachment to this grid. - Link for adding an attachment to this grid.
 ...
 */
export type _LinksAddAttachment4 = z.infer<typeof _linksAddAttachment4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
