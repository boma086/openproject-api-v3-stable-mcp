 ...
 */
export const _linksScope1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksScope1} _linksScope1 - The location where this grid is used, usually represented as a relative URL. - The location where this grid is used, usually represented as a relative URL.
 ...
 */
export type _LinksScope1 = z.infer<typeof _linksScope1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksScope1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksScope1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
