 ...
 */
export const _linksAddAttachment7 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksAddAttachment7} _linksAddAttachment7 - Attach a file to the post

# Conditions

**Permission**: edit messages - Attach a file to the post
 ...
 */
export type _LinksAddAttachment7 = z.infer<typeof _linksAddAttachment7>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment7Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAddAttachment7Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
