 ...
 */
export const _linksTypes1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksTypes1} _linksTypes1 - The collection of types.

**Resource**: Collection - The collection of types.
 ...
 */
export type _LinksTypes1 = z.infer<typeof _linksTypes1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksTypes1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksTypes1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
