 ...
 */
export const _linksSelf1 = z.lazy(() => {
  return z.object({
...
**Resource**: Root
 * @typedef  {_LinksSelf1} _linksSelf1 - This root information object.

**Resource**: Root - This root information object.
 ...
 */
export type _LinksSelf1 = z.infer<typeof _linksSelf1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
