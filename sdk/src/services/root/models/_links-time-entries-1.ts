 ...
 */
export const _linksTimeEntries1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksTimeEntries1} _linksTimeEntries1 - The collection of time entries.

**Resource**: Collection - The collection of time entries.
 ...
 */
export type _LinksTimeEntries1 = z.infer<typeof _linksTimeEntries1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksTimeEntries1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksTimeEntries1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
