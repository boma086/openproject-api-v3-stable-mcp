 ...
 */
export const _linksUser1 = z.lazy(() => {
  return z.object({
...
**Resource**: User
 * @typedef  {_LinksUser1} _linksUser1 - The current user resource.

**Resource**: User - The current user resource.
 ...
 */
export type _LinksUser1 = z.infer<typeof _linksUser1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUser1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUser1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
