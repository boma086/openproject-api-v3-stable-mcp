 ...
 */
export const priorities = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {Priorities} priorities - The collection of priorities.

**Resource**: Collection - The collection of priorities.
 ...
 */
export const prioritiesResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const prioritiesRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
