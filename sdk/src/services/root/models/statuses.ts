...
**Resource**: Collection
 * @typedef  {Statuses} statuses - The collection of statuses.

**Resource**: Collection - The collection of statuses.
 ...
 */
export const statusesResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const statusesRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
