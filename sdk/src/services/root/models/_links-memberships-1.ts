 ...
 */
export const _linksMemberships1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksMemberships1} _linksMemberships1 - The collection of memberships.

**Resource**: Collection - The collection of memberships.
 ...
 */
export type _LinksMemberships1 = z.infer<typeof _linksMemberships1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMemberships1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksMemberships1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
