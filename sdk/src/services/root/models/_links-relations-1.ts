 ...
 */
export const _linksRelations1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksRelations1} _linksRelations1 - The collection of relations.

**Resource**: Collection - The collection of relations.
 ...
 */
export type _LinksRelations1 = z.infer<typeof _linksRelations1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRelations1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksRelations1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
