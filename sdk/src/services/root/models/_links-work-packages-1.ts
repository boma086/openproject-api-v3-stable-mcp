 ...
 */
export const _linksWorkPackages1 = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {_LinksWorkPackages1} _linksWorkPackages1 - The work package collection.

**Resource**: Collection - The work package collection.
 ...
 */
export type _LinksWorkPackages1 = z.infer<typeof _linksWorkPackages1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackages1Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksWorkPackages1Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
