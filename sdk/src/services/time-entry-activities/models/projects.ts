...
**Resource**: Project
 * @typedef  {Projects} projects - One of the projects the time entry is active in.

**Resource**: Project - One of the projects the time entry is active in.
 ...
 */
export const projectsResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const projectsRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
