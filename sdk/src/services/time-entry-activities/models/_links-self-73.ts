 ...
 */
export const _linksSelf73 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf73} _linksSelf73 - This time entry activity

**Resource**: TimeEntriesActivity - This time entry activity
 ...
 */
export type _LinksSelf73 = z.infer<typeof _linksSelf73>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf73Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf73Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
