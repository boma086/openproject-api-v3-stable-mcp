 ...
 */
export const _linksAttachments3 = z.lazy(() => {
  return z.object({
...
**Resource**: []Attachment
 * @typedef  {_LinksAttachments3} _linksAttachments3 - The attachments belonging to the document

**Resource**: []Attachment - The attachments belonging to the document
 ...
 */
export type _LinksAttachments3 = z.infer<typeof _linksAttachments3>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments3Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksAttachments3Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
