 ...
 */
export const _linksProject4 = z.lazy(() => {
  return z.object({
...
**Resource**: Project
 * @typedef  {_LinksProject4} _linksProject4 - The project the document is in

**Resource**: Project - The project the document is in
 ...
 */
export type _LinksProject4 = z.infer<typeof _linksProject4>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject4Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksProject4Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
