 ...
 */
export const _linksUpdateImmediately9 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately9} _linksUpdateImmediately9 - An href to update the placeholder user.

# Conditions:

- `manage_placeholder_user`

**Resource**: PlaceholderUser - An href to update the placeholder user.
 ...
 */
export type _LinksUpdateImmediately9 = z.infer<typeof _linksUpdateImmediately9>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately9Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately9Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
