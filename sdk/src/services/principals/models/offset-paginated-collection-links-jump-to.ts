 ...
 */
export const offsetPaginatedCollectionLinksJumpTo = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {OffsetPaginatedCollectionLinksJumpTo} offsetPaginatedCollectionLinksJumpTo - A templated link to jump to a given offset. - A templated link to jump to a given offset.
 ...
 */
export type OffsetPaginatedCollectionLinksJumpTo = z.infer<typeof offsetPaginatedCollectionLinksJumpTo>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksJumpToResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksJumpToRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
