 ...
 */
export const offsetPaginatedCollectionLinksChangeSize = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {OffsetPaginatedCollectionLinksChangeSize} offsetPaginatedCollectionLinksChangeSize - A templated link to change the current page size. - A templated link to change the current page size.
 ...
 */
export type OffsetPaginatedCollectionLinksChangeSize = z.infer<typeof offsetPaginatedCollectionLinksChangeSize>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksChangeSizeResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksChangeSizeRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
