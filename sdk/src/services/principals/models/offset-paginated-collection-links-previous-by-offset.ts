 ...
 */
export const offsetPaginatedCollectionLinksPreviousByOffset = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {OffsetPaginatedCollectionLinksPreviousByOffset} offsetPaginatedCollectionLinksPreviousByOffset - A link to the previous page of the collection.

# Conditions
- The collection is not on the first page. - A link to the previous page of the collection.
 ...
 */
export type OffsetPaginatedCollectionLinksPreviousByOffset = z.infer<
  typeof offsetPaginatedCollectionLinksPreviousByOffset
>;
 ...
 */
export const offsetPaginatedCollectionLinksPreviousByOffsetResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksPreviousByOffsetRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
