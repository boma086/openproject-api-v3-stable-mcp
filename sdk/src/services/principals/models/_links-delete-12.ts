 ...
 */
export const _linksDelete12 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksDelete12} _linksDelete12 - An href to delete the placeholder user.

# Conditions:

- `manage_placeholder_user` - An href to delete the placeholder user.
 ...
 */
export type _LinksDelete12 = z.infer<typeof _linksDelete12>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete12Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksDelete12Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
