 ...
 */
export const offsetPaginatedCollectionLinksSelf = z.lazy(() => {
  return z.object({
...
**Resource**: Collection
 * @typedef  {OffsetPaginatedCollectionLinksSelf} offsetPaginatedCollectionLinksSelf - This collection resource.

**Resource**: Collection - This collection resource.
 ...
 */
export type OffsetPaginatedCollectionLinksSelf = z.infer<typeof offsetPaginatedCollectionLinksSelf>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksSelfResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksSelfRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
