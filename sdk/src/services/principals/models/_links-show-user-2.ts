 ...
 */
export const _linksShowUser2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksShowUser2} _linksShowUser2 - A relative path to show the placeholder user in the web application. - A relative path to show the placeholder user in the web application.
 ...
 */
export type _LinksShowUser2 = z.infer<typeof _linksShowUser2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksShowUser2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
