 ...
 */
export const offsetPaginatedCollectionLinksNextByOffset = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {OffsetPaginatedCollectionLinksNextByOffset} offsetPaginatedCollectionLinksNextByOffset - A link to the next page of the collection.

# Conditions
- The collection is not on the last page. - A link to the next page of the collection.
 ...
 */
export type OffsetPaginatedCollectionLinksNextByOffset = z.infer<typeof offsetPaginatedCollectionLinksNextByOffset>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksNextByOffsetResponse = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const offsetPaginatedCollectionLinksNextByOffsetRequest = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
