 ...
 */
export const _linksUpdateImmediately11 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksUpdateImmediately11} _linksUpdateImmediately11 - Persist the query without using a Form based process for guidance

# Conditions

**Permission**: save queries for own queries, manage public queries for public queries; - Persist the query without using a Form based process for guidance
 ...
 */
export type _LinksUpdateImmediately11 = z.infer<typeof _linksUpdateImmediately11>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately11Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksUpdateImmediately11Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
