 ...
 */
export const _linksParent2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksParent2} _linksParent2 - The hierarchy item that is the parent of the current hierarchy item

**Resource**: HierarchyItem - The hierarchy item that is the parent of the current hierarchy item
 ...
 */
export type _LinksParent2 = z.infer<typeof _linksParent2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksParent2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
