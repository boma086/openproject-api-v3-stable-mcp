 ...
 */
export const _linksChildren2 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksChildren2} _linksChildren2 - A hierarchy item that is a child of the current hierarchy item

**Resource**: HierarchyItem - A hierarchy item that is a child of the current hierarchy item
 ...
 */
export type _LinksChildren2 = z.infer<typeof _linksChildren2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChildren2Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksChildren2Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
