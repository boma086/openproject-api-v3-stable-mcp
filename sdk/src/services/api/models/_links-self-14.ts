 ...
 */
export const _linksSelf14 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf14} _linksSelf14 - This hierarchy item collection

**Resource**: HierarchyItemCollectionModel - This hierarchy item collection
 ...
 */
export type _LinksSelf14 = z.infer<typeof _linksSelf14>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf14Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf14Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
