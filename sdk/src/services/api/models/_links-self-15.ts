 ...
 */
export const _linksSelf15 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {_LinksSelf15} _linksSelf15 - This hierarchy item

**Resource**: HierarchyItem - This hierarchy item
 ...
 */
export type _LinksSelf15 = z.infer<typeof _linksSelf15>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf15Response = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const _linksSelf15Request = z.lazy(() => {
  return z
    .object({
      href: z.string().nullable(),
      title: z.string().optional(),
